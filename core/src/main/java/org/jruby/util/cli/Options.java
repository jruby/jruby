...
public class Options {
    ...
    public static final Option<Boolean> SYMBOL_TO_STRING_FROZEN = bool(MISCELLANEOUS, "symbol.to_s.frozen", false, "Toggle whether to make Symbol to_s method return a frozen String.");

...
public class Options {
    ...
    public static final Option<Boolean> GRAALVM_NATIVE_COMPILE = bool(JVM, "graalvm.native.compile", false, "Disable features that limit or prevent GraalVM native compilation.");

 ...
 * @author kares
 */
public class ClassLoaderAwareWriter extends ClassWriter {

    private final ClassLoader loader;

    public ClassLoaderAwareWriter(final int flags) {
        super(flags);
        this.loader = getClass().getClassLoader();
    }

    public ClassLoaderAwareWriter(final ClassLoader loader, final int flags) {
        super(flags);
        this.loader = loader;
    }

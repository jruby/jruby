...
public class RubyObjectSpecializer {
    ...
    private static ClassAndAllocator generateSpecializedRubyObject(String className, int size, boolean cache) {
        ClassAndAllocator cna;
        ...
        synchronized (LOADER) {
            ...
            try {
                ...
                specialized = LOADER.loadClass(className.replace('/', '.'));
    ...
    private static Class generateInternal(final String clsPath, int size) {

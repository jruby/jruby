...
public class RubyStringByteList extends RubyString {
    ...
    public static RubyStringByteList[] NULL_ARRAY = {};
    ...
    public static RubyClass createStringClass(ThreadContext context, RubyClass Object, RubyModule Comparable) {
        return defineClass(context, "String", Object, RubyStringByteList::newAllocatedString).
                reifiedClass(RubyStringByteList.class).
                kindOf(new RubyModule.JavaClassKindOf(RubyStringByteList.class)).
                classIndex(ClassIndex.STRING).
                include(context, Comparable).
                defineMethods(context, RubyStringByteList.class);
    }
    ...
    private void copyCodeRangeForSubstr(RubyStringByteList from, Encoding enc) {
    ...
    final Encoding isCompatibleWith(EncodingCapable other) {
        if (other instanceof RubyStringByteList otherStr) return checkEncoding(otherStr);
    ...
    // rb_enc_check
    public final Encoding checkEncoding(RubyStringByteList other) {
    ...
    private boolean eqlAndComparable(IRubyObject other) {
        final RubyStringByteList otherString = (RubyStringByteList) other;
    ...
    public RubyStringByteList(Ruby runtime, RubyClass rubyClass) {
        this(runtime, rubyClass, ByteList.NULL_ARRAY);
    }

    public RubyStringByteList(Ruby runtime, RubyClass rubyClass, CharSequence value) {
        this(runtime, rubyClass, value, UTF8);
    }

    public RubyStringByteList(Ruby runtime, RubyClass rubyClass, CharSequence value, Encoding enc) {
    ...
    private RubyStringByteList(Ruby runtime, RubyClass rubyClass, String value, Encoding enc) {
        super(runtime, rubyClass);
        assert value != null;
        assert enc != null;
    ...
    protected RubyStringByteList(Ruby runtime, RubyClass rubyClass, String value, Encoding enc, boolean objectspace) {
    ...
    public RubyStringByteList(Ruby runtime, RubyClass rubyClass, byte[] value) {
        super(runtime, rubyClass);
        assert value != null;
        this.value = new ByteList(value);
    }

    public RubyStringByteList(Ruby runtime, RubyClass rubyClass, ByteList value) {
        super(runtime, rubyClass);
        assert value != null;
        this.value = value;
    }

    public RubyStringByteList(Ruby runtime, RubyClass rubyClass, ByteList value, boolean objectSpace) {
        super(runtime, rubyClass, objectSpace);
        assert value != null;
        this.value = value;
    }

    public RubyStringByteList(Ruby runtime, RubyClass rubyClass, ByteList value, Encoding encoding, boolean objectSpace) {
        this(runtime, rubyClass, value, objectSpace);
        value.setEncoding(encoding);
    }

    protected RubyStringByteList(Ruby runtime, RubyClass rubyClass, ByteList value, Encoding enc, int cr) {
        this(runtime, rubyClass, value);
        flags |= cr;
        value.setEncoding(enc);
    }

    protected RubyStringByteList(Ruby runtime, RubyClass rubyClass, ByteList value, Encoding enc) {
        this(runtime, rubyClass, value);
        value.setEncoding(enc);
    }

    protected RubyStringByteList(Ruby runtime, RubyClass rubyClass, ByteList value, int cr) {
        this(runtime, rubyClass, value);
        flags |= cr;
    }

    protected RubyStringByteList(Ruby runtime, RubyClass rubyClass, ByteList value, int cr, boolean objectspace) {
        this(runtime, rubyClass, value, objectspace);
        flags |= cr;
    }
    ...
    public static RubyStringByteList newStringLight(Ruby runtime, ByteList bytes) {
        return new RubyStringByteList(runtime, runtime.getString(), bytes, false);
    }

    public static RubyStringByteList newStringLight(Ruby runtime, int size) {
        checkNegativeSize(runtime, size);
        return new RubyStringByteList(runtime, runtime.getString(), new ByteList(size), false);
    }

    public static RubyStringByteList newStringLight(Ruby runtime, int size, Encoding encoding) {
        checkNegativeSize(runtime, size);
    ...
    public static RubyStringByteList newString(Ruby runtime, CharSequence str) {
        return new RubyStringByteList(runtime, runtime.getString(), str, UTF8);
    }

    public static RubyStringByteList newString(Ruby runtime, CharSequence str, Encoding encoding) {
        return new RubyStringByteList(runtime, runtime.getString(), str, encoding);
    }

    public static RubyStringByteList newString(Ruby runtime, String str) {
        return new RubyStringByteList(runtime, runtime.getString(), str, UTF8);
    }

    public static RubyStringByteList newString(Ruby runtime, String str, Encoding encoding) {
        return new RubyStringByteList(runtime, runtime.getString(), str, encoding);
    }

    public static RubyStringByteList newBinaryString(Ruby runtime, String str) {
        return new RubyStringByteList(runtime, runtime.getString(), new ByteList(ByteList.plain(str), ASCIIEncoding.INSTANCE, false));
    }

    public static RubyStringByteList newBinaryString(Ruby runtime, ByteList str) {
        return new RubyStringByteList(runtime, runtime.getString(), str, ASCIIEncoding.INSTANCE, false);
    }

    public static RubyStringByteList newUSASCIIString(Ruby runtime, String str) {
        return new RubyStringByteList(runtime, runtime.getString(), str, USASCIIEncoding.INSTANCE);
    }

    public static RubyStringByteList newString(Ruby runtime, byte[] bytes) {
        return new RubyStringByteList(runtime, runtime.getString(), bytes);
    }

    public static RubyStringByteList newString(Ruby runtime, byte[] bytes, int start, int length) {
        return newString(runtime, bytes, start, length, ASCIIEncoding.INSTANCE);
    }

    // rb_enc_str_new
    public static RubyStringByteList newString(Ruby runtime, byte[] bytes, int start, int length, Encoding encoding) {
        byte[] copy = new byte[length];
        System.arraycopy(bytes, start, copy, 0, length);
        return new RubyStringByteList(runtime, runtime.getString(), new ByteList(copy, encoding, false));
    }

    public static RubyStringByteList newStringNoCopy(Ruby runtime, byte[] bytes, int start, int length, Encoding encoding) {
        return new RubyStringByteList(runtime, runtime.getString(), new ByteList(bytes, start, length, encoding, false));
    }

    public static RubyStringByteList newString(Ruby runtime, ByteList bytes) {
        return new RubyStringByteList(runtime, runtime.getString(), bytes);
    }

    public static RubyStringByteList newString(Ruby runtime, ByteList bytes, int coderange) {
        return new RubyStringByteList(runtime, runtime.getString(), bytes, coderange);
    }

    public static RubyStringByteList newChilledString(Ruby runtime, ByteList bytes, int coderange, String file, int line) {
    ...
    public static RubyStringByteList newString(Ruby runtime, ByteList bytes, Encoding encoding) {
        return new RubyStringByteList(runtime, runtime.getString(), bytes, encoding);
    }

    static RubyStringByteList newString(Ruby runtime, byte b) {
        return new RubyStringByteList(runtime, runtime.getString(), RubyInteger.singleCharByteList(b));
    }

    @SuppressWarnings("ReferenceEquality")
    public static RubyStringByteList newUnicodeString(Ruby runtime, String str) {
        return runtime.getDefaultInternalEncoding() == UTF16BEEncoding.INSTANCE ?
            newUTF16String(runtime, str) : newUTF8String(runtime, str);
    }

    public static RubyStringByteList newUTF8String(Ruby runtime, String str) {
        return new RubyStringByteList(runtime, runtime.getString(), RubyEncoding.doEncodeUTF8(str));
    }

    public static RubyStringByteList newUTF16String(Ruby runtime, String str) {
        return new RubyStringByteList(runtime, runtime.getString(), RubyEncoding.doEncodeUTF16(str));
    }

    @SuppressWarnings("ReferenceEquality")
    public static RubyStringByteList newUnicodeString(Ruby runtime, CharSequence str) {
        return runtime.getDefaultInternalEncoding() == UTF16BEEncoding.INSTANCE ?
            newUTF16String(runtime, str) : newUTF8String(runtime, str);
    }

    public static RubyStringByteList newUTF8String(Ruby runtime, CharSequence str) {
        return new RubyStringByteList(runtime, runtime.getString(), RubyEncoding.doEncodeUTF8(str));
    }

    public static RubyStringByteList newUTF16String(Ruby runtime, CharSequence str) {
        return new RubyStringByteList(runtime, runtime.getString(), RubyEncoding.doEncodeUTF16(str));
    }
     ...
     * @return
     */
    public static RubyStringByteList newInternalFromJavaExternal(Ruby runtime, String str) {
        // Ruby internal
        ...
        if ( rubyInt == null ) {
            ...
            return RubyStringByteList.newString(runtime, new ByteList(str.getBytes(), javaExtEncoding));
        }
        return RubyStringByteList.newString(runtime,  new ByteList(RubyEncoding.encode(str, rubyInt), internal));
    }

    // String construction routines by NOT byte[] buffer and making the target String shared
    public static RubyStringByteList newStringShared(Ruby runtime, RubyStringByteList orig) {
        orig.shareLevel = SHARE_LEVEL_BYTELIST;
        RubyStringByteList str = new RubyStringByteList(runtime, runtime.getString(), orig.value);
        str.shareLevel = SHARE_LEVEL_BYTELIST;
        return str;
    }

    public static RubyStringByteList newStringShared(Ruby runtime, ByteList bytes) {
        return newStringShared(runtime, runtime.getString(), bytes);
    }

    public static RubyStringByteList newStringShared(Ruby runtime, ByteList bytes, Encoding encoding) {
        return newStringShared(runtime, runtime.getString(), bytes, encoding);
    }


    public static RubyStringByteList newStringShared(Ruby runtime, ByteList bytes, int codeRange) {
        RubyStringByteList str = new RubyStringByteList(runtime, runtime.getString(), bytes, codeRange);
        str.shareLevel = SHARE_LEVEL_BYTELIST;
        return str;
    }

    public static RubyStringByteList newStringShared(Ruby runtime, RubyClass clazz, ByteList bytes) {
        RubyStringByteList str = new RubyStringByteList(runtime, clazz, bytes);
        str.shareLevel = SHARE_LEVEL_BYTELIST;
        return str;
    }

    @SuppressWarnings("ReferenceEquality")
    public static RubyStringByteList newStringShared(Ruby runtime, RubyClass clazz, ByteList bytes, Encoding encoding) {
        if (bytes.getEncoding() == encoding) return newStringShared(runtime, clazz, bytes);
        RubyStringByteList str = new RubyStringByteList(runtime, clazz, bytes.makeShared(bytes.getBegin(), bytes.getRealSize()), encoding);
        str.shareLevel = SHARE_LEVEL_BUFFER; // since passing an encoding in does bytes.setEncoding(encoding)
        return str;
    }

    private static RubyStringByteList newStringShared(Ruby runtime, ByteList bytes, Encoding encoding, int cr) {
        RubyStringByteList str = newStringShared(runtime, runtime.getString(), bytes, encoding);
        str.flags |= cr;
        return str;
    }

    @Deprecated(since = "10.0.0.0")
    public static RubyStringByteList newStringShared(Ruby runtime, byte[] bytes) {
        return newStringShared(runtime, bytes, 0, bytes.length, ASCIIEncoding.INSTANCE);
    }

    @Deprecated(since = "10.0.0.0")
    public static RubyStringByteList newStringShared(Ruby runtime, byte[] bytes, Encoding encoding) {
        return newStringShared(runtime, bytes, 0, bytes.length, encoding);
    }

    @Deprecated(since = "10.0.0.0")
    public static RubyStringByteList newStringShared(Ruby runtime, byte[] bytes, int start, int length) {
        return newStringShared(runtime, bytes, start, length, ASCIIEncoding.INSTANCE);
    }

    public static RubyStringByteList newStringShared(Ruby runtime, byte[] bytes, int start, int length, Encoding encoding) {
        ByteList byteList = new ByteList(bytes, start, length, encoding, false);
        RubyStringByteList str = new RubyStringByteList(runtime, runtime.getString(), byteList);
        str.shareLevel = SHARE_LEVEL_BUFFER;
        return str;
    }

    public static RubyStringByteList newEmptyString(Ruby runtime) {
        return newEmptyString(runtime, runtime.getString());
    }

    public static RubyStringByteList newEmptyBinaryString(Ruby runtime) {
    ...
    public static RubyStringByteList newAllocatedString(Ruby runtime, RubyClass metaClass) {
        RubyStringByteList empty = new RubyStringByteList(runtime, metaClass, EMPTY_ASCII8BIT_BYTELIST);
        empty.shareLevel = SHARE_LEVEL_BYTELIST;
        return empty;
    }

    public static RubyStringByteList newEmptyString(Ruby runtime, RubyClass metaClass) {
        RubyStringByteList empty = new RubyStringByteList(runtime, metaClass, EMPTY_USASCII_BYTELIST);
        empty.shareLevel = SHARE_LEVEL_BYTELIST;
        return empty;
    }

    // String construction routines by NOT byte[] buffer and NOT making the target String shared
    public static RubyStringByteList newStringNoCopy(Ruby runtime, ByteList bytes) {
        return newStringNoCopy(runtime, runtime.getString(), bytes);
    }

    public static RubyStringByteList newStringNoCopy(Ruby runtime, RubyClass clazz, ByteList bytes) {
        return new RubyStringByteList(runtime, clazz, bytes);
    }

    public static RubyStringByteList newStringNoCopy(Ruby runtime, byte[] bytes, int start, int length) {
        return newStringNoCopy(runtime, new ByteList(bytes, start, length, false));
    }

    public static RubyStringByteList newStringNoCopy(Ruby runtime, byte[] bytes) {
    ...
    public final RubyStringByteList makeIndependent() {
        RubyClass klass = metaClass;
        RubyStringByteList str = strDup(klass.runtime, klass);
        str.modify();
        str.setFrozen(true);
        return str;
    }
    ...
    public final RubyStringByteList makeIndependent(final int length) {
        RubyClass klass = metaClass;
        RubyStringByteList str = strDup(klass.runtime, klass);
        str.modify(length);
        str.setFrozen(true);
    ...
    public static RubyStringByteList newEmptyString(Ruby runtime, RubyClass metaClass, Encoding enc) {
        EmptyByteListHolder holder = getEmptyByteList(enc);
        RubyStringByteList empty = new RubyStringByteList(runtime, metaClass, holder.bytes, holder.cr);
        empty.shareLevel = SHARE_LEVEL_BYTELIST;
        return empty;
    }

    public static RubyStringByteList newEmptyString(Ruby runtime, Encoding enc) {
        return newEmptyString(runtime, runtime.getString(), enc);
    }

    public static RubyStringByteList newStringNoCopy(Ruby runtime, RubyClass clazz, ByteList bytes, Encoding enc, int cr) {
        return new RubyStringByteList(runtime, clazz, bytes, enc, cr);
    }

    public static RubyStringByteList newStringNoCopy(Ruby runtime, ByteList bytes, Encoding enc, int cr) {
        return newStringNoCopy(runtime, runtime.getString(), bytes, enc, cr);
    }

    public static RubyStringByteList newUsAsciiStringNoCopy(Ruby runtime, ByteList bytes) {
        return newStringNoCopy(runtime, bytes, USASCIIEncoding.INSTANCE, CR_7BIT);
    }

    public static RubyStringByteList newUsAsciiStringShared(Ruby runtime, ByteList bytes) {
        RubyStringByteList str = newUsAsciiStringNoCopy(runtime, bytes);
        str.shareLevel = SHARE_LEVEL_BYTELIST;
        return str;
    }

    public static RubyStringByteList newUsAsciiStringShared(Ruby runtime, byte[] bytes, int start, int length) {
        RubyStringByteList str = newUsAsciiStringNoCopy(runtime, new ByteList(bytes, start, length, false));
        str.shareLevel = SHARE_LEVEL_BUFFER;
        return str;
    }
    ...
    @Override
    public RubyStringByteList convertToString() {
        return this;
    }
    ...
    public IRubyObject dupFrozen() {
        RubyStringByteList dup = (RubyStringByteList) dup();
        dup.setFrozen(true);
        return dup;
    }
    ...
    // MRI: rb_str_dup
    public final RubyStringByteList strDup(Ruby runtime) {
        return strDup(runtime, metaClass.getRealClass());
    }

    public final RubyStringByteList strDup(Ruby runtime, RubyClass clazz) {
        shareLevel = SHARE_LEVEL_BYTELIST;
        RubyStringByteList dup = new RubyStringByteList(runtime, clazz, value);
    ...
    public final RubyStringByteList dupAsChilled(Ruby runtime, RubyClass clazz, String file, int line) {
        if (runtime.getInstanceConfig().isDebuggingFrozenStringLiteral()) {
            shareLevel = SHARE_LEVEL_BYTELIST;
            RubyStringByteList dup = new DebugChilledString(runtime, clazz, value, getCodeRange(), file, line + 1 + 1);
            dup.flags |= flags & CR_MASK;
    ...
    public final RubyStringByteList makeShared(Ruby runtime, RubyClass meta, int index, int len) {
        final RubyStringByteList shared;
        if (len == 0) {
    ...
    private RubyString makeShared(Ruby runtime, RubyClass meta, ByteList value, int index, int len) {
        ...
        if (len == 0) {
            ...
            if (shareLevel == SHARE_LEVEL_NONE) shareLevel = SHARE_LEVEL_BUFFER;
            RubyStringByteList shared2 = new RubyStringByteList(runtime, meta, value.makeShared(index, len));
            shared2.shareLevel = SHARE_LEVEL_BUFFER;
            shared2.copyCodeRangeForSubstr(this, enc); // no need to assign encoding, same bytelist shared
            shared = shared2;
        }
        return shared;
    }
    ...
    public RubyStringByteList newFrozen() {
        if (isFrozen()) return this;

        RubyStringByteList str = strDup(metaClass.runtime);
        str.setCodeRange(getCodeRange());
        str.setFrozen(true);
        return str;
    }

    public static RubyStringByteList newDebugFrozenString(Ruby runtime, RubyClass rubyClass, ByteList value, int cr, String file, int line) {
        return new DebugFrozenString(runtime, rubyClass, value, cr, file, line);
    }

    public static RubyStringByteList newDebugChilledString(Ruby runtime, RubyClass rubyClass, ByteList value, int cr, String file, int line) {
    ...
    @Override
    public RubyStringByteList asString() {
        return this;
    }
    ...
    public IRubyObject op_cmp(ThreadContext context, IRubyObject other) {
        if (other instanceof RubyStringByteList otherStr) return asFixnum(context, op_cmp(otherStr));
        ...
        if (sites.respond_to_X.respondsTo(context, this, other)) {
            ...
            if (tmp instanceof RubyStringByteList otherStr) return asFixnum(context, op_cmp(otherStr));
            return context.nil;
        } else {
    ...
    public IRubyObject op_equal(ThreadContext context, IRubyObject other) {
        ...
        return other instanceof RubyStringByteList otherStr ?
    ...
    public IRubyObject op_plus19(ThreadContext context, IRubyObject arg) {
        ...
        RubyString rubyString = arg.convertToString();
        if (rubyString instanceof RubyStringByteList str) {
            ...
            RubyStringByteList resultStr = newStringNoCopy(context.runtime, StringSupport.addByteLists(value, str.value),
                    enc, CodeRangeSupport.codeRangeAnd(getCodeRange(), str.getCodeRange()));
            return resultStr;
        }

        throw new RuntimeException("unexpected string type: " + arg.getMetaClass().getName());
    }
    ...
    private RubyStringByteList multiplyByteList(ThreadContext context, IRubyObject arg) {
        ...
        return Create.newStringByteList(context, bytes);
    }

        public RubyStringByteList op_format(ThreadContext context, IRubyObject arg) {
        IRubyObject tmp;
        ...
        return Create.newStringByteList(context, out);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof RubyStringByteList otherStr) && equals(otherStr);
    }

    @SuppressWarnings("NonOverridingEquals")
    final boolean equals(RubyString other) {
        if (other instanceof RubyStringByteList otherStr) return otherStr.value.equal(value);
        throw new RuntimeException("unexpected string type: " + other.getClass());
    }

    /** rb_obj_as_string
     *
     */
    public static RubyStringByteList objAsString(ThreadContext context, IRubyObject obj) {
        if (obj instanceof RubyStringByteList str) return str;
        IRubyObject str = sites(context).to_s.call(context, obj, obj);
        if (!(str instanceof RubyStringByteList)) return (RubyStringByteList) Convert.anyToString(context, obj);
        // TODO: MRI sets an fstring flag on fstrings and uses that flag here
        return (RubyStringByteList) str;
    }
    ...
    public final int op_cmp(RubyString other) {
        if (other instanceof RubyStringByteList otherStr) {
            int ret = value.cmp(otherStr.value);
            if (ret == 0 && !StringSupport.areComparable(this, other)) {
                return value.getEncoding().getIndex() > otherStr.value.getEncoding().getIndex() ? 1 : -1;
            }
            return ret;
        }
        throw new RuntimeException("unexpected string type: " + other.getClass());
    ...
    public final RubyStringByteList cat(byte[] str) {
    ...
    public final RubyStringByteList cat(byte[] str, int beg, int len) {
    ...
    public final RubyStringByteList cat(RubyString str) {
        return cat(str.getByteList());
    }

    public final RubyStringByteList cat(ByteList str) {
    ...
    public final RubyStringByteList cat(byte ch) {
    ...
    public final RubyStringByteList cat(int code, Encoding enc) {
    ...
    public final RubyStringByteList catAscii(byte[] bytes, int ptr, int ptrLen) {
        Encoding enc = value.getEncoding();
    ...
    @Deprecated(since = "10.0.0.0")
    public RubyStringByteList replace19(IRubyObject other) {
        return replace(getCurrentContext(), other);
    }

    @Deprecated(since = "10.0.0.0")
    public RubyStringByteList initialize_copy(IRubyObject other) {
        return initialize_copy(getCurrentContext(), other);
    }

        public RubyStringByteList initialize_copy(ThreadContext context, IRubyObject other) {
     ...
     *
     */
        public RubyStringByteList replace(ThreadContext context, IRubyObject other) {
        modifyCheck();
    ...
    private RubyStringByteList replaceCommon(IRubyObject other) {
        modifyCheck();
        RubyString rubyString = other.convertToString();
        if (rubyString instanceof RubyStringByteList otherStr) {
            otherStr.shareLevel = shareLevel = SHARE_LEVEL_BYTELIST;
            value = otherStr.value;
            return otherStr;
        }
        throw new RuntimeException("unexpected string type: " + other.getMetaClass().getName());
    }

    @Deprecated(since = "10.0.0.0")
    public RubyStringByteList clear() {
        return clear(getCurrentContext());
    }

    @JRubyMethod
    public RubyStringByteList clear(ThreadContext context) {
        modifyCheck();
        Encoding enc = value.getEncoding();
    ...
    @Deprecated(since = "10.0.0.0")
    public RubyStringByteList reverse_bang19(ThreadContext context) {
        return reverse_bang(context);
    }

        public RubyStringByteList reverse_bang(ThreadContext context) {
        modifyCheck();
     ...
     *
     */
    public static RubyStringByteList newInstance(IRubyObject recv, IRubyObject[] args, Block block) {
        RubyStringByteList newString = newStringShared(recv.getRuntime(), ByteList.EMPTY_BYTELIST);
    ...
    private IRubyObject initialize(ThreadContext context, IRubyObject arg0, RubyHash opts) {
        ...
        RubyStringByteList otherStr = (RubyStringByteList) tmp;
        ...
        RubyStringByteList down = dupString(context, this);
        down.downcase_bang(context, flags);
        RubyStringByteList otherDown = dupString(context, otherStr);
    ...
    public IRubyObject op_match(ThreadContext context, IRubyObject other) {
        ...
        if (other instanceof RubyStringByteList) throw typeError(context, "type mismatch: String given");
    ...
    public IRubyObject op_ge19(ThreadContext context, IRubyObject other) {
        ...
        return other instanceof RubyStringByteList otherStr && cmpIsBuiltin(context) ?
    ...
    public IRubyObject str_eql_p19(ThreadContext context, IRubyObject other) {
        ...
        return asBoolean(context,
                other instanceof RubyStringByteList otherStr && StringSupport.areComparable(this, otherStr) && value.equal(otherStr.value));
    }
     ...
     *
     */
        public RubyStringByteList upcase(ThreadContext context) {
        RubyStringByteList str = dupString(context, this);
        str.upcase_bang(context);
        return str;
    }

        public RubyStringByteList upcase(ThreadContext context, IRubyObject arg) {
        RubyStringByteList str = dupString(context, this);
        str.upcase_bang(context, arg);
        return str;
    }

        public RubyStringByteList upcase(ThreadContext context, IRubyObject arg0, IRubyObject arg1) {
        RubyStringByteList str = dupString(context, this);
     ...
     *
     */
        public RubyStringByteList downcase(ThreadContext context) {
        RubyStringByteList str = dupString(context, this);
        str.downcase_bang(context);
        return str;
    }

        public RubyStringByteList downcase(ThreadContext context, IRubyObject arg) {
        RubyStringByteList str = dupString(context, this);
        str.downcase_bang(context, arg);
        return str;
    }

        public RubyStringByteList downcase(ThreadContext context, IRubyObject arg0, IRubyObject arg1) {
        RubyStringByteList str = dupString(context, this);
     ...
     *
     */
        public RubyStringByteList swapcase(ThreadContext context) {
        RubyStringByteList str = dupString(context, this);
        str.swapcase_bang(context);
        return str;
    }

        public RubyStringByteList swapcase(ThreadContext context, IRubyObject arg) {
        RubyStringByteList str = dupString(context, this);
        str.swapcase_bang(context, arg);
        return str;
    }

        public RubyStringByteList swapcase(ThreadContext context, IRubyObject arg0, IRubyObject arg1) {
        RubyStringByteList str = dupString(context, this);
     ...
     *
     */
        public RubyStringByteList capitalize(ThreadContext context) {
        RubyStringByteList str = dupString(context, this);
        str.capitalize_bang(context);
        return str;
    }

        public RubyStringByteList capitalize(ThreadContext context, IRubyObject arg) {
        RubyStringByteList str = dupString(context, this);
        str.capitalize_bang(context, arg);
        return str;
    }

        public RubyStringByteList capitalize(ThreadContext context, IRubyObject arg0, IRubyObject arg1) {
        RubyStringByteList str = dupString(context, this);
     ...
     */
        ...
        final RubyStringByteList result = Create.newStringByteList(context, outBytes);
        Encoding enc = value.getEncoding();
        ...
        RubyStringByteList undumped = newString(context.runtime, sBytes, s[0], 0, enc[0]);
        boolean[] utf8 = {false};
    ...
    public CharSequence subSequence(int start, int end) {
        ...
        return (RubyStringByteList) subStr;
    }
     ...
     */
    private static IRubyObject byteSize(ThreadContext context, RubyStringByteList recv, IRubyObject[] args) {
     ...
     *
     */
    public RubyStringByteList append(IRubyObject other, Function<IRubyObject, RubyString> convert) {
    ...
    public RubyStringByteList append(IRubyObject other) {
    ...
    public RubyStringByteList append19(IRubyObject other) {
        return append(other);
    }

    public RubyStringByteList appendAsDynamicString(IRubyObject other) {
        return append(other, (o) -> o.asString());
    }

    public RubyStringByteList appendAsStringOrAny(IRubyObject other) {
        return append(other, (o) -> (RubyStringByteList) o.anyToString());
    }
     ...
     */
        ...
        if (other instanceof RubyFloat flote) {
            modifyCheck();
            return catWithCodeRange((RubyStringByteList) flote.to_s(context));
        }
     ...
     *
     */
        public RubyStringByteList concat(ThreadContext context, IRubyObject[] objs) {
        modifyCheck();

        if (objs.length > 0) {
            RubyStringByteList tmp = newStringLight(context.runtime, objs.length, getEncoding());
    ...
    @SuppressWarnings("ReferenceEquality")
    private RubyStringByteList concatNumeric(ThreadContext context, int c) {
        Encoding enc = value.getEncoding();
        int cl;
    ...
    public final RubyStringByteList prepend(byte ch) {
        modify(value.getRealSize() + 1);
    ...
    public final RubyStringByteList prepend(int ch) {
     ...
     *
     */
    public RubyStringByteList crypt(ThreadContext context, IRubyObject other) {
        ...
        RubyStringByteList result = RubyStringByteList.newStringNoCopy(context.runtime, cryptedString, 0, cryptedString.length - 1);
        result.associateEncoding(ascii8bit);
        return result;
    }

    /* RubyString aka rb_string_value */
    public static RubyStringByteList stringValue(IRubyObject object) {
        return (RubyStringByteList) (object instanceof RubyStringByteList ? object : object.convertToString());
    }
    ...
    public IRubyObject sub_bang(ThreadContext context, IRubyObject arg0, IRubyObject arg1, Block block) {
            ...
            if (hash == context.nil) {
                RubyString rubyString = arg1.convertToString();

                if (rubyString instanceof RubyStringByteList rsbl) {
                    return subBangNoIter(context, arg0, rsbl);
                }
                throw new RuntimeException("unexpected string type: " + rubyString.getClass().getName());
            }
    ...
    private IRubyObject subBangIter(ThreadContext context, RubyStringByteList pattern, RubyHash hash, Block block) {
        int len = value.getRealSize();
        byte[] bytes = value.getUnsafeBytes();
        Encoding enc = value.getEncoding();
    ...
    private IRubyObject subBangNoIter(ThreadContext context, IRubyObject arg0, RubyStringByteList repl) {
    ...
    private IRubyObject subBangNoIter(ThreadContext context, RubyStringByteList pattern, RubyStringByteList repl) {
        final int mBeg = StringSupport.index(getByteList(), pattern.getByteList(), 0, checkEncoding(pattern));
        if (mBeg > -1) {
    ...
    private IRubyObject subBangNoIter(ThreadContext context, RubyRegexp regexp, RubyStringByteList repl) {
        RubyMatchData match = subBangMatch(context, regexp);
        if (match != null) {
    ...
    public final IRubyObject subBangFast(ThreadContext context, RubyRegexp regexp, RubyString repl) {
        RubyMatchData match = subBangMatch(context, regexp);
        if (match != null) {
            RubyStringByteList repl2 = RubyRegexp.regsub(context, convertToByteListString(repl), this, regexp.pattern, match.regs, match.begin, match.end);
            subBangCommon(context, match.begin, match.end, repl2);
            return match;
        }
        return context.nil;
    }

    private RubyMatchData subBangMatch(ThreadContext context, RubyRegexp regexp) {
        Regex pattern = regexp.getPattern(context);
        Regex prepared = regexp.preparePattern(context, this);
    ...
    private RubyStringByteList subBangCommon(ThreadContext context, final int beg, final int end,
                                             final RubyStringByteList repl) { // the sub replacement string
        ...
        setCodeRange(cr);
        return (RubyStringByteList) this; // this
    }

    private Encoding subBangVerifyEncoding(ThreadContext context, final RubyStringByteList repl, final int beg, final int end) {
        final ByteList value = this.value;
        byte[] bytes = value.getUnsafeBytes();
        int p = value.getBegin();
        int len = value.getRealSize();
    ...
    private IRubyObject gsubImpl(ThreadContext context, IRubyObject arg0, IRubyObject arg1, Block block, final boolean bang) {
        ...
        final RubyHash hash;
        final RubyStringByteList str;
        if (tryHash == context.nil) {
            hash = null;
            RubyString str2 = arg1.convertToString();
            if (!(str2 instanceof RubyStringByteList strSBL)) {
                throw new RuntimeException(arg1 + " is not a string");
            }
            str = strSBL;
        } else {
    ...
    public RubyStringByteList gsubFast(ThreadContext context, RubyRegexp regexp, RubyString repl, Block block) {
        return (RubyStringByteList) gsubCommon(context, block, convertToByteListString(repl), null, regexp, false, false);
    }

    private IRubyObject gsubCommon(ThreadContext context, Block block, RubyStringByteList repl,
    ...
    private IRubyObject gsubCommon(ThreadContext context, Block block, RubyStringByteList repl,
                                   RubyHash hash, RubyStringByteList pattern, final boolean bang, boolean useBackref) {
        ...
        RubyStringByteList dest = Create.newStringByteList(context, new ByteList(spLen + 30));
    ...
    // MRI: rb_strseq_index
    private int strseqIndex(final RubyStringByteList sub, int offset, boolean inBytes) {
        int s, sptr, e;
        int pos, len, slen;
    ...
    private IRubyObject byteARef(ThreadContext context, IRubyObject idx) {
        ...
        if (obj.isNil() || ((RubyStringByteList)obj).getByteList().length() == 0) return context.nil;
        return obj;
    }
    ...
    /* rb_str_splice */
    private IRubyObject replaceInternal(int beg, int len, RubyStringByteList repl) {
        StringSupport.replaceInternal(beg, len, this, repl);
        return this;
    }

    @Deprecated(since = "10.0.0.0")
    private void replaceInternal19(Ruby runtime, int beg, int len, RubyStringByteList repl) {
    ...
    public IRubyObject op_aref(ThreadContext context, IRubyObject arg) {
        ...
        } else if (arg instanceof RubyStringByteList str) {
    ...
    public IRubyObject bytesplice(ThreadContext context, IRubyObject[] args) {
        ...
        if (!(val instanceof RubyStringByteList valSBL)) {
            throw new RuntimeException("unexpected string type: " + val.getClass());
        }

        int[] vbegvlen = {toInt(context, args[3]), toInt(context, args[4])};

        checkBegLen(context, beglen);
        valSBL.checkBegLen(context, vbegvlen);

        return bytespliceCommon(valSBL, beglen[0], beglen[1], vbegvlen[0], vbegvlen[1]);
    }
    ...
    public IRubyObject bytesplice(ThreadContext context, IRubyObject arg0, IRubyObject arg1) {
        ...
        int vbeg = 0;
        int vlen = valSBL.getByteList().realSize();

        // simpler check for vbeg, vlen since we know the indices are valid
        valSBL.checkBegLenPositions(context, vbeg, vlen);

        return bytespliceCommon(valSBL, beglen[0], beglen[1], vbeg, vlen);
    }
    ...
    private RubyStringByteList bytespliceOffsets(ThreadContext context, IRubyObject index, IRubyObject length, IRubyObject str) {
    ...
    private RubyStringByteList bytespliceRange(ThreadContext context, IRubyObject arg0, IRubyObject arg1, IRubyObject arg2) {
        int[] beglen = new int[2];
    ...
    private RubyStringByteList bytespliceCommon(RubyStringByteList val, int beg, int len, int vbeg, int vlen) {
    ...
    // MRI: rb_str_update_1
    private void strUpdate1(int beg, int len, RubyStringByteList val, int vbeg, int vlen) {
        if (beg == 0 && vlen == 0) {
            dropBytes(len);
            return;
        }
    ...
    private IRubyObject op_aref(ThreadContext context, int idx) {
        ...
        return !str.isNil() && ((RubyStringByteList) str).value.getRealSize() == 0 ? context.nil : str;
    }
    ...
    private void subpatSet(ThreadContext context, RubyRegexp regexp, IRubyObject backref, IRubyObject repl) {
        ...
        RubyString val = repl.convertToString();

        if (!(val instanceof RubyStringByteList replStr)) {
            throw new RuntimeException("unexpected string type: " + val.getClass());
        }
    ...
    public IRubyObject op_aset(ThreadContext context, IRubyObject arg0, IRubyObject arg1) {
        ...
        if (arg0 instanceof RubyRegexp regexp) {
            ...
            return arg1;
        } else if (arg0 instanceof RubyStringByteList orig) {
    ...
    final IRubyObject uptoCommon(ThreadContext context, RubyString _end, boolean excl, Block block, boolean asSymbol) {
        RubyStringByteList end = convertToByteListString(_end);

        Encoding enc = checkEncoding(end);
        boolean isAscii = scanForCodeRange() == CR_7BIT && end.scanForCodeRange() == CR_7BIT;
        ByteList endByteList = end.getByteList();
        if (value.getRealSize() == 1 && endByteList.getRealSize() == 1 && isAscii) {
            byte c = value.getUnsafeBytes()[value.getBegin()];
            byte e = endByteList.getUnsafeBytes()[endByteList.getBegin()];
            ...
            return this;
        } else if (isAscii && ASCII.isDigit(value.getUnsafeBytes()[value.getBegin()]) && ASCII.isDigit(endByteList.getUnsafeBytes()[endByteList.getBegin()])) {
            int s = value.getBegin();
            ...
            if (b instanceof RubyFixnum bb && e instanceof RubyFixnum ee) {
                ...
                while (bl <= el) {
                    ...
                    RubyStringByteList str = RubyStringByteList.newStringNoCopy(context.runtime, to, USASCIIEncoding.INSTANCE, CR_7BIT);
    ...
    private IRubyObject uptoCommonNoDigits(ThreadContext context, RubyString _end, boolean excl, Block block, boolean asSymbol) {
        RubyStringByteList end = convertToByteListString(_end);
        int n = op_cmp(end);
        ...
        if (isAscii && ASCII.isDigit(value.getUnsafeBytes()[value.getBegin()])) {
            ...
            if (b instanceof RubyFixnum bb) {
                ...
                while (bl < RubyFixnum.MAX) {
                    ...
                    Sprintf.sprintf(to, "%.*d", argsArr);
                    current = RubyStringByteList.newStringNoCopy(context.runtime, to, USASCIIEncoding.INSTANCE, CR_7BIT);
    ...
    public RubyBoolean include_p(ThreadContext context, IRubyObject obj) {
        RubyString val = obj.convertToString();

        if (!(val instanceof RubyStringByteList coerced)) {
            throw new RuntimeException("unexpected string type: " + val.getClass());
        }
    ...
    private RubyArray splitCommon(ThreadContext context, IRubyObject pat, int lim) {
        ...
        if (splitPattern == context.nil) {                  // AWK SPLIT
            ...
            RubyStringByteList splitString = (RubyStringByteList) splitPattern;
            ((RubyStringByteList)splitPattern).mustnotBroken(context);

            if (splitString.isEmpty()) { // SPLIT_TYPE_CHARS
                RubyRegexp pattern = RubyRegexp.newRegexpFromStr(context.runtime, splitString, 0);
                result = regexSplit(context, pattern, limit, lim);
            } else {
                ByteList spatValue = ((RubyStringByteList)splitPattern).value;
        ...
        if (!limit && lim == 0) {
            while (!result.isEmpty() && ((RubyStringByteList) result.eltInternal(result.size() - 1)).value.getRealSize() == 0) {
                result.pop(context);
            }
        }
    ...
    private Object determineSplitPattern(ThreadContext context, IRubyObject pat) {
        ...
        RubyStringByteList stringPattern = (RubyStringByteList) pattern;
    ...
    private RubyArray stringSplit(ThreadContext context, RubyStringByteList spat, boolean limit, int lim) {
    ...
    private static RubyStringByteList getStringForPattern(ThreadContext context, IRubyObject obj) {
        if (obj instanceof RubyStringByteList str) return str;
        IRubyObject val = obj.checkStringType();
        if (val.isNil()) throw typeError(context, obj, "Regexp");
        return (RubyStringByteList) val;
    }
    ...
    private static IRubyObject getPatternQuoted(ThreadContext context, IRubyObject pat) {
        ...
        if (pat instanceof RubyStringByteList) return pat;
    ...
    private static Object getScanPatternQuoted(ThreadContext context, IRubyObject pat) {
        ...
        if (pat instanceof RubyStringByteList str && str.isBrokenString()) {
    ...
    public IRubyObject scan(ThreadContext context, IRubyObject pat, Block block) {
        final RubyStringByteList str = this;
    ...
    // MRI: scan_once
    private static IRubyObject scanOnce(ThreadContext context, RubyStringByteList str, IRubyObject pat, int[] startp) {
    ...
    // MRI: rb_pat_search
    private static int patternSearch(ThreadContext context, final IRubyObject pattern, RubyStringByteList str, final int pos) {
        if (pattern instanceof RubyStringByteList strPattern) {
    ...
    private static RubyMatchData setBackRefString(ThreadContext context, RubyStringByteList str, int pos, RubyStringByteList pattern) {
    ...
    public boolean startsWith(final RubyString _str) {
        RubyStringByteList str = convertToByteListString(_str);
    ...
    protected boolean endWith(IRubyObject tmp) {
        ...
        ByteList tmpBL = ((RubyStringByteList)tmp).value;
        ...
        Encoding enc = checkEncoding((RubyStringByteList)tmp);
    ...
    private int deletedPrefixLength(IRubyObject _prefix) {
        RubyString val = _prefix.convertToString();

        if (!(val instanceof RubyStringByteList prefix)) {
            throw new RuntimeException("unexpected string type: " + val.getClass());
        }
    ...
    private int deletedSuffixLength(IRubyObject _suffix) {
        RubyString val = _suffix.convertToString();

        if (!(val instanceof RubyStringByteList suffix)) {
            throw new RuntimeException("unexpected string type: " + val.getClass());
        }
    ...
    private IRubyObject justify(ThreadContext context, IRubyObject arg0, int jflag) {
        RubyStringByteList result = justifyCommon(context, SPACE_BYTELIST, 1, true, EncodingUtils.STR_ENC_GET(this), toInt(context, arg0), jflag);
    ...
    private IRubyObject justify(ThreadContext context, IRubyObject arg0, IRubyObject arg1, int jflag) {
        ...
        if (!(val instanceof RubyStringByteList padStr)) {
            throw new RuntimeException("unexpected string type: " + val.getClass());
        }
        ...
        RubyStringByteList result = justifyCommon(context, pad,
                                                   padCharLen,
    ...
    private RubyStringByteList justifyCommon(ThreadContext context, ByteList pad, int padCharLen, boolean padSinglebyte,
        ...
        RubyStringByteList result = Create.newStringByteList(context, res);
    ...
    public IRubyObject partition(ThreadContext context, IRubyObject arg, Block block) {
        ...
        return newArrayNoCopy(context, makeSharedString(context.runtime, 0, pos), sep,
                makeSharedString(context.runtime, pos + sep.getByteList().getRealSize(), value.getRealSize() - pos - sep.getByteList().getRealSize()));
    }
    ...
    public IRubyObject rpartition(ThreadContext context, IRubyObject arg) {
        final int pos;
        final RubyStringByteList sep;
        if (arg instanceof RubyRegexp) {
            IRubyObject tmp = rindex(context, arg);
            if (tmp.isNil()) return rpartitionMismatch(context);
            pos = toInt(context, tmp);
            sep = (RubyStringByteList)RubyRegexp.nth_match(context, 0, context.getLocalMatchOrNil());
        } else {
            IRubyObject tmp = arg.checkStringType();
            if (tmp.isNil()) throw typeError(context, "type mismatch: ", arg, " given");
            sep = (RubyStringByteList)tmp;
    ...
    private static int byteCapacityFor(ThreadContext context, IRubyObject arg) {
        return switch (arg) {
            ...
            case RubyStringByteList str -> str.getByteList().realSize();
            default ->
    ...
    private void appendBytes(ThreadContext context, IRubyObject arg) {
        switch (arg) {
            ...
            case RubyStringByteList str -> value.append(str.getByteList());
    ...
    @Deprecated(since = "10.0.0.0")
    public RubyStringByteList chomp19(ThreadContext context) {
        return chomp(context);
    }

    @Deprecated(since = "10.0.0.0")
    public RubyStringByteList chomp19(ThreadContext context, IRubyObject arg0) {
     ...
     *   all(!)).
     */
    public RubyStringByteList chomp(ThreadContext context) {
        RubyStringByteList str = dupString(context, this);
        str.chomp_bang(context);
        return str;
    }

    public RubyStringByteList chomp(ThreadContext context, IRubyObject arg0) {
        RubyStringByteList str = dupString(context, this);
    ...
    private IRubyObject chompBangCommon(ThreadContext context, IRubyObject rsObj) {
        ...
        RubyString val = rsObj.convertToString();

        if (!(val instanceof RubyStringByteList rs)) {
            throw new RuntimeException("unexpected string type: " + val.getClass());
        }
    ...
    public IRubyObject count(ThreadContext context, IRubyObject arg) {
        RubyString val = arg.convertToString();

        if (!(val instanceof RubyStringByteList countStr)) {
            throw new RuntimeException("unexpected string type: " + val.getClass());
        }
        ...
        TrTables tables = StringSupport.trSetupTable(context, countValue, table, null, true, enc);
    ...
    public IRubyObject count(ThreadContext context, IRubyObject[] args) {
        ...
        RubyString val = args[0].convertToString();
        ...
        final boolean[] table = new boolean[StringSupport.TRANS_SIZE + 1];
        TrTables tables = StringSupport.trSetupTable(context, countStr.value, table, null, true, enc);
        for (int i = 1; i < argc; i++ ) {
            RubyString val2 = args[i].convertToString();

            if (!(val2 instanceof RubyStringByteList countStr2)) {
                throw new RuntimeException("unexpected string type: " + val2.getClass());
            }
            countStr = countStr2;
    ...
    public IRubyObject delete_bang(ThreadContext context, IRubyObject arg) {
        ...
        RubyStringByteList otherStr = convertToByteListString(arg);
        Encoding enc = checkEncoding(otherStr);
        final boolean[] squeeze = new boolean[StringSupport.TRANS_SIZE + 1];
        TrTables tables = StringSupport.trSetupTable(context, otherStr.value, squeeze, null, true, enc);
    ...
    public IRubyObject delete_bang(ThreadContext context, IRubyObject[] args) {
        ...
        RubyStringByteList otherStr;
        Encoding enc = null;
        boolean[] squeeze = new boolean[StringSupport.TRANS_SIZE + 1];
        TrTables tables = null;

        for (int i = 0; i < argc; i++) {
            IRubyObject arg = args[i];
            otherStr = convertToByteListString(arg);
    ...
    private static RubyStringByteList convertToByteListString(IRubyObject arg) {
        RubyString val = arg.convertToString();

        if (!(val instanceof RubyStringByteList otherStr2)) {
            throw new RuntimeException("unexpected string type: " + val.getClass());
        }
        return otherStr2;
    }
    ...
    public IRubyObject squeeze_bang(ThreadContext context, IRubyObject arg) {
        RubyStringByteList otherStr = convertToByteListString(arg);
        final boolean squeeze[] = new boolean[StringSupport.TRANS_SIZE + 1];
        TrTables tables = StringSupport.trSetupTable(context, otherStr.value, squeeze, null, true, checkEncoding(otherStr));
    ...
    public IRubyObject squeeze_bang(ThreadContext context, IRubyObject[] args) {
        ...
        RubyStringByteList otherStr = convertToByteListString(args[0]);
        Encoding enc = checkEncoding(otherStr);
        final boolean squeeze[] = new boolean[StringSupport.TRANS_SIZE + 1];
        TrTables tables = StringSupport.trSetupTable(context, otherStr.value, squeeze, null, true, enc);
        ...
        for (int i = 1; i< argc; i++) {
            otherStr = convertToByteListString(args[i]);
            enc = checkEncoding(otherStr);
    ...
    private IRubyObject trTrans(ThreadContext context, IRubyObject src, IRubyObject repl, boolean sflag) {
        RubyStringByteList replStr = convertToByteListString(repl);
        ByteList replList = replStr.value;
        RubyStringByteList srcStr = convertToByteListString(src);
     ...
     * @see SizeFn#size(ThreadContext, IRubyObject, IRubyObject[])
     */
    private static IRubyObject eachCharSize(ThreadContext context, RubyStringByteList recv, IRubyObject[] args) {
    ...
    private IRubyObject enumerateChars(ThreadContext context, String name, Block block, boolean wantarray) {
        ...
        if (block.isGiven()) {
            ...
            return enumeratorizeWithSize(context, str, name, RubyStringByteList::eachCharSize);
        }
    ...
    private IRubyObject enumerateCodepoints(ThreadContext context, String name, Block block, boolean wantarray) {
        ...
        if (block.isGiven()) {
            ...
            return enumeratorizeWithSize(context, str, name, RubyStringByteList::codepointSize);
        }
    ...
    private IRubyObject enumerateBytes(ThreadContext context, String name, Block block, boolean wantarray) {
        if (block.isGiven()) {
            ...
            return enumeratorizeWithSize(context, this, name, RubyStringByteList::byteSize);
        }
     ...
     * @see SizeFn#size(ThreadContext, IRubyObject, IRubyObject[])
     */
    private static IRubyObject codepointSize(ThreadContext context, RubyStringByteList recv, IRubyObject[] args) {
        return recv.rubyLength(context);
    }
     ...
     * @see SizeFn#size(ThreadContext, IRubyObject, IRubyObject[])
     */
    private static IRubyObject eachGraphemeClusterSize(ThreadContext context, RubyStringByteList self, IRubyObject[] args) {
    ...
    private IRubyObject enumerateGraphemeClusters(ThreadContext context, String name, Block block, boolean wantarray) {
        ...
        if (block.isGiven()) {
            ...
            return enumeratorizeWithSize(context, str, name, RubyStringByteList::eachGraphemeClusterSize);
        }
        ...
        while (ptr < end) {
            ...
            if (len <= 0) break;
            RubyStringByteList result = newStringShared(context.runtime, ptrBytes, ptr, len, enc);
    ...
    public IRubyObject encode_bang(ThreadContext context) {
        ...
        return EncodingUtils.strTranscode(context, this, RubyStringByteList::updateFromTranscode);
    }

    public IRubyObject encode_bang(ThreadContext context, IRubyObject arg0) {
        modifyAndClearCodeRange();

        return EncodingUtils.strTranscode(context, arg0, this, RubyStringByteList::updateFromTranscode);
    }

    public IRubyObject encode_bang(ThreadContext context, IRubyObject arg0, IRubyObject arg1) {
        modifyAndClearCodeRange();

        return EncodingUtils.strTranscode(context, arg0, arg1, this, RubyStringByteList::updateFromTranscode);
    }

    public IRubyObject encode_bang(ThreadContext context, IRubyObject arg0, IRubyObject arg1, IRubyObject arg2) {
        modifyAndClearCodeRange();

        return EncodingUtils.strTranscode(context, arg0, arg1, arg2, this, RubyStringByteList::updateFromTranscode);
    }
    ...
    public IRubyObject b(ThreadContext context) {
        ...
        RubyStringByteList dup = dupString(context, this);
        dup.clearCodeRange();
    ...
    public RubyStringByteList chill() {
        flags |= CHILLED_LITERAL;
        return this;
    }

    public RubyStringByteList chill_symbol_string() {
    ...
    public IRubyObject encStrScrub(ThreadContext context, Encoding enc, IRubyObject repl, int cr, Block block) {
        ...
        if (enc.isAsciiCompatible()) {
            ...
            if (block.isGiven()) {
                ...
                repBytes = ((RubyStringByteList)repl).value.unsafeBytes();
                rep = ((RubyStringByteList)repl).value.begin();
                replen = ((RubyStringByteList)repl).value.getRealSize();
                rep7bit_p = (((RubyStringByteList)repl).getCodeRange() == CR_7BIT);
            }
            ...
            while (p < e) {
                ...
                if (MBCLEN_NEEDMORE_P(ret)) {
                    ...
                    if (buf.isNil()) buf = RubyStringByteList.newStringLight(context.runtime, value.getRealSize());
                    if (p > p1) {
                        ((RubyStringByteList)buf).cat(pBytes, p1, p - p1);
                    }
                    ...
                    if (repBytes != null) {
                        ((RubyStringByteList)buf).cat(repBytes, rep, replen);
                        if (!rep7bit_p) cr = CR_VALID;
                    }
                    else {
                        repl = block.yieldSpecific(context, RubyStringByteList.newString(context.runtime, pBytes, p, clen, enc));
                        repl = EncodingUtils.strCompatAndValid(context, repl, enc);
                        ((RubyStringByteList)buf).cat((RubyStringByteList)repl);
                        if (((RubyStringByteList)repl).getCodeRange() == CR_VALID)
                            cr = CR_VALID;
                    }
                    p += clen;
                    p1 = p;
            ...
            if (buf.isNil()) {
                ...
                buf = RubyStringByteList.newStringLight(context.runtime, value.getRealSize());
            }
            if (p1 < p) {
                ((RubyStringByteList)buf).cat(pBytes, p1, p - p1);
            }
            if (p < e) {
                if (repBytes != null) {
                    ...
                    repl = block.yieldSpecific(context, RubyStringByteList.newString(context.runtime, pBytes, p, e - p, enc));
                    repl = EncodingUtils.strCompatAndValid(context, repl, enc);
                    ((RubyStringByteList)buf).cat((RubyStringByteList)repl);
                    if (((RubyStringByteList)repl).getCodeRange() == CR_VALID)
                        cr = CR_VALID;
            ...
            while (p < e) {
                ...
                if (MBCLEN_NEEDMORE_P(ret)) {
                    ...
                    int clen = enc.maxLength();
                    if (buf.isNil()) buf = RubyStringByteList.newStringLight(context.runtime, value.getRealSize());
                    if (p > p1) ((RubyStringByteList)buf).cat(pBytes, p1, p - p1);
        ...
        ((RubyStringByteList)buf).setEncodingAndCodeRange(enc, cr);
        return buf;
    }
    ...
    public static IRubyObject includeRange(ThreadContext context, RubyStringByteList _beg, RubyStringByteList _end, IRubyObject _val, boolean exclusive) {
        if (_val.isNil()) return context.fals;
        _val = TypeConverter.checkStringType(context.runtime, _val);
        if (_val.isNil()) return context.fals;

        final RubyStringByteList val = convertToByteListString(_val);
        final RubyStringByteList beg = _beg.newFrozen();
        final RubyStringByteList end = _end.newFrozen();

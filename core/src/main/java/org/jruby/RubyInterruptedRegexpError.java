...
public class RubyInterruptedRegexpError extends RubyRegexpError {
    ...
    static RubyClass define(ThreadContext context, RubyClass RegexpError) {
        return defineClass(context, "InterruptedRegexpError", RegexpError, RubyInterruptedRegexpError::new);
    }

...
public abstract class EncodingNodes {
    ...
    @CoreMethod(names = "default_external", isModuleFunction = true, needsSelf = false, maxArgs = 0)
    ...
    @CoreMethod(names = "default_internal", isModuleFunction = true, needsSelf = false, maxArgs = 0)
    ...
    @CoreMethod(names = "find", isModuleFunction = true, needsSelf = false, maxArgs = 1, minArgs = 1)

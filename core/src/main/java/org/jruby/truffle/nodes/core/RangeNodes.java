...
public abstract class RangeNodes {
    ...
    public abstract static class IncludeNode extends CoreMethodNode {
        ...
        public IncludeNode(RubyContext context, SourceSection sourceSection) {
            super(context, sourceSection);
            callLess = new DispatchHeadNode(context, getSourceSection(), "<", false);
            callGreater = new DispatchHeadNode(context, getSourceSection(), ">", false);
            callGreaterEqual = new DispatchHeadNode(context, getSourceSection(), ">=", false);
        }

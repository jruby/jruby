...
public abstract class RangeNodes {
    ...
    public abstract static class IncludeNode extends CoreMethodNode {
        ...
        public IncludeNode(RubyContext context, SourceSection sourceSection) {
            super(context, sourceSection);
            callLess = new DispatchHeadNode(context, false, "<", false, DispatchHeadNode.MissingBehavior.CALL_METHOD_MISSING);
            callGreater = new DispatchHeadNode(context, false, ">", false, DispatchHeadNode.MissingBehavior.CALL_METHOD_MISSING);
            callGreaterEqual = new DispatchHeadNode(context, false, ">=", false, DispatchHeadNode.MissingBehavior.CALL_METHOD_MISSING);
        }
    ...
    public abstract static class ToSNode extends CoreMethodNode {
        ...
        public ToSNode(RubyContext context, SourceSection sourceSection) {
            super(context, sourceSection);
            toS = new DispatchHeadNode(context, false, "to_s", false, DispatchHeadNode.MissingBehavior.CALL_METHOD_MISSING);
        }

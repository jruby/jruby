...
public class VariableAccessorVar2 extends FieldVariableAccessor {
     ...
     */
    public VariableAccessorVar2(RubyClass realClass, String name, int index, int classId) {
        super(realClass, name, index, classId, 2);
    }
    ...
    public Object get(Object object) {
        return ((ReifiedRubyObject) object).getVariable2();
    }
    ...
    public static void setVariable(RubyBasicObject self, RubyClass realClass, int index, Object value) {
        ((ReifiedRubyObject) self).setVariable2(value);
    }
}

...
public class VariableAccessorVar0 extends FieldVariableAccessor {
     ...
     */
    public VariableAccessorVar0(RubyClass realClass, String name, int index, int classId) {
        super(realClass, name, index, classId, 0);
    }
    ...
    public Object get(Object object) {
        return ((ReifiedRubyObject) object).getVariable0();
    }
    ...
    public static void setVariable(RubyBasicObject self, RubyClass realClass, int index, Object value) {
        ((ReifiedRubyObject) self).setVariable0(value);
    }
}

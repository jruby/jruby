...
public class VariableAccessorVar9 extends FieldVariableAccessor {
     ...
     */
    public VariableAccessorVar9(RubyClass realClass, String name, int index, int classId) {
        super(realClass, name, index, classId, 9);
    }
    ...
    public Object get(Object object) {
        return ((ReifiedRubyObject) object).getVariable9();
    }
    ...
    public static void setVariable(RubyBasicObject self, RubyClass realClass, int index, Object value) {
        ((ReifiedRubyObject) self).setVariable9(value);
    }
}

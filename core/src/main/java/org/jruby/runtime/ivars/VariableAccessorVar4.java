...
public class VariableAccessorVar4 extends FieldVariableAccessor {
     ...
     */
    public VariableAccessorVar4(RubyClass realClass, String name, int index, int classId) {
        super(realClass, name, index, classId, 4);
    }
    ...
    public Object get(Object object) {
        return ((ReifiedRubyObject) object).getVariable4();
    }
    ...
    public static void setVariable(RubyBasicObject self, RubyClass realClass, int index, Object value) {
        ((ReifiedRubyObject) self).setVariable4(value);
    }
}

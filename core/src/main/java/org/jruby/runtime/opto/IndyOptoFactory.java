...
public class IndyOptoFactory implements OptoFactory {
    private final Ruby runtime;

    public IndyOptoFactory(Ruby runtime) {
    ...
    public final Object newConstantWrapper(Class type, Object object) {
        return IndyOptoFactory.CONSTANT_FACTORY.create(type, object);
    }
    ...
    static Boolean indyEnabled() {
        return Options.COMPILE_INVOKEDYNAMIC.load();
    }

    static void disableIndy() {
     ...
     */
    static final ConstantFactory CONSTANT_FACTORY = new MethodHandleConstantFactory();
}

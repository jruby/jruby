 ...
 * @see ArgumentError
 */
@JRubyClass(name="NoMatchingPatternError", parent="StandardError")
public class RubyNoMatchingPatternError extends RubyStandardError {
    protected RubyNoMatchingPatternError(Ruby runtime, RubyClass exceptionClass) {
        super(runtime, exceptionClass);
    }

    protected RubyNoMatchingPatternError(Ruby runtime, RubyClass exceptionClass, String message) {
    ...
    protected RaiseException constructThrowable(String message) {
        return new NoMatchingPatternError(message, this);
    }
}

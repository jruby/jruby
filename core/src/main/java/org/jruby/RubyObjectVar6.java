 ...
 */
public class RubyObjectVar6 extends RubyObjectVar5 {
    /**
     * Standard path for object creation. Objects are entered into ObjectSpace
     * only if ObjectSpace is enabled.
     */
    public RubyObjectVar6(Ruby runtime, RubyClass metaClass) {
        super(runtime, metaClass);
    }
    
    public static void setVariableChecked(RubyObjectVar6 self, Object value) {

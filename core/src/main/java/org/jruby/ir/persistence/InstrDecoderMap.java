...
class InstrDecoderMap implements IRPersistenceValues {
    ...
    public Instr decodeInner(Operation operation) {
        switch(operation) {
            ...
            case CALL_1F: case CALL_1D: case CALL_1O: case CALL_1OB: case CALL_0O: case CALL: return CallInstr.decode(d);
            ...
            case DEF_CLASS: return DefineClassInstr.decode(d);
            case DEF_CLASS_METH: return DefineClassMethodInstr.decode(d);
            case DEF_INST_METH: return DefineInstanceMethodInstr.decode(d);
            case DEF_META_CLASS: return DefineMetaClassInstr.decode(d);
            case DEF_MODULE: return DefineModuleInstr.decode(d);
            case EQQ: return EQQInstr.decode(d);
            case EXC_REGION_END: return new ExceptionRegionEndMarkerInstr();
            case EXC_REGION_START: return ExceptionRegionStartMarkerInstr.decode(d);
            case GET_CVAR: return GetClassVariableInstr.decode(d);
            ...
            case NORESULT_CALL: case NORESULT_CALL_1O: return NoResultCallInstr.decode(d);

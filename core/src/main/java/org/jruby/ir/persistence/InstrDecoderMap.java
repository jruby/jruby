...
class InstrDecoderMap implements IRPersistenceValues {
    ...
    public Instr decode(Operation operation) {
        switch(operation) {
            ...
            case BINDING_LOAD: return decodeBindingLoad();
            case BINDING_STORE:return decodeBindingStore();
            ...
            case CLASS_VAR_MODULE: return decodeClassVarModule();
            ...
            case DEFINED_CONSTANT_OR_METHOD: return decodeConstantOrMethod();
            case DEF_CLASS: return decodeDefineClass();
            case DEF_CLASS_METH: return decodeDefineClassMethod();
            case DEF_INST_METH: return decodeDefineInstanceMethod();
            case DEF_META_CLASS: return decodeDefineInstanceMethod();
            case DEF_MODULE: return decodeDefineModule();
            ...
            case PUSH_BINDING: return decodePushBindingInstr();
            ...
            case RECORD_END_BLOCK: return decodeRecordEndBlockInstr();
            ...
            case SUPER: return decodeSuper(); // FIXME: three instrs all use this...probably need to change something.
    ...
    private Instr decodeBindingLoad() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    private Instr decodeBindingStore() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    private Instr decodeBreak() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
    ...
    private Instr decodeClassVarModule() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    private Instr decodeConstantOrMethod() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    private Instr decodeDefineClass() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    private Instr decodeDefineClassMethod() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    private Instr decodeDefineInstanceMethod() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    private Instr decodeDefineModule() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
    ...
    private Instr decodePushBindingInstr() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    private Instr decodeRecordEndBlockInstr() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    private Instr decodeSuper() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

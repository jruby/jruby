...
class OperandDecoderMap {
    ...
    public Operand decode(OperandType type) {
        ...
        switch (type) {
            ...
            case LOCAL_VARIABLE: return new LocalVariable(d.decodeString(), d.decodeInt(), d.decodeInt());
            ...
            case TEMPORARY_VARIABLE: return new TemporaryVariable(d.decodeString(), d.decodeInt());

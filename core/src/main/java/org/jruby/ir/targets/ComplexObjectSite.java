...
*/
public class ComplexObjectSite extends LazyObjectSite {
    private final String value;
    private final String encoding;

    public ComplexObjectSite(MethodType type, String value, String encoding) {
        super(type);
    ...
    public static CallSite bootstrap(MethodHandles.Lookup lookup, String name, MethodType type, String value, String encoding) {
        return new ComplexObjectSite(type, value, encoding).bootstrap(lookup);
    }

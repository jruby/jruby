...
class IndyDynamicValueCompiler implements DynamicValueCompiler {
    ...
    public void array(int length) {
        ...
        compiler.adapter.invokedynamic("array", sig(JVM.OBJECT, params(ThreadContext.class, JVM.OBJECT, length)), Bootstrap.array());
    }

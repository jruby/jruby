...
project 'JRuby Core' do
  ...
  jar 'com.oracle:truffle:0.5-SNAPSHOT'
  jar 'com.oracle:truffle-dsl-processor:0.5-SNAPSHOT'  # TODO(CS) this should only be a compile-time dependency - how to do that?

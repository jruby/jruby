...
project 'JRuby Base' do
  ...
  jar 'com.github.jnr:jnr-unixsocket:0.38.0', :exclusions => ['com.github.jnr:jnr-ffi']
  jar 'com.github.jnr:jnr-posix:3.1.1-SNAPSHOT', :exclusions => ['com.github.jnr:jnr-ffi']

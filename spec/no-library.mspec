...
class MSpecScript
  ...
  set :ci_files, [
    ...
    File.dirname(__FILE__) + '/ruby/library/conditionvariable',
    ...
    File.dirname(__FILE__) + '/ruby/library/ftools',
    File.dirname(__FILE__) + '/ruby/library/generator',
    File.dirname(__FILE__) + '/ruby/library/getoptlong',
    ...
    File.dirname(__FILE__) + '/ruby/library/parsedate',
    File.dirname(__FILE__) + '/ruby/library/pathname',
    File.dirname(__FILE__) + '/ruby/library/queue',

...
public class EvStrNode extends Node implements StringExpandableNode {
    ...
    public EvStrNode(RubyObject literal) {
    ...
    public RubyString expandString(Ruby ruby, RubyObject self, Node parent) {
        ...
        parent.setHeadNode(ruby.getRubyParser().compileString(ruby.getSourceFile(), getLiteral(), ruby.getSourceLine()));

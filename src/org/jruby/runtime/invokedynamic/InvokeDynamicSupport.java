...
public class InvokeDynamicSupport {
    public static Object bootstrap(final CallSite site, Object... args) {
        ...
        } else if (site.name() == "fcall") {
            callType = CallType.FUNCTIONAL;
        } else {//if (site.name() == "vcall") {
        ...
        MethodHandle outHandle = MethodHandles.findStatic(InvokeDynamicSupport.class, "invokeDynamic",
        ...
        if (args[length - 1] instanceof Block) {
            switch (length) {
            case 4:
                return method.call(context, self, self.getMetaClass(), methodName, (Block) args[length - 1]);
            case 5:
                if (args[length - 2] instanceof IRubyObject[]) {
                    return method.call(context, self, self.getMetaClass(), methodName, (IRubyObject[]) args[length - 2], (Block) args[length - 1]);
                } else {
                    return method.call(context, self, self.getMetaClass(), methodName, (IRubyObject) args[length - 2], (Block) args[length - 1]);
                }
            case 6:
                return method.call(context, self, self.getMetaClass(), methodName, (IRubyObject) args[length - 3], (IRubyObject) args[length - 2], (Block) args[length - 1]);
            case 7:
                return method.call(context, self, self.getMetaClass(), methodName, (IRubyObject) args[length - 4], (IRubyObject) args[length - 3], (IRubyObject) args[length - 2], (Block) args[length - 1]);
            }
        } else {
            switch (length) {
            case 3:
                return method.call(context, self, self.getMetaClass(), methodName);
            case 4:
                if (args[length - 1] instanceof IRubyObject[]) {
                    return method.call(context, self, self.getMetaClass(), methodName, (IRubyObject[]) args[length - 1]);
                } else {
                    return method.call(context, self, self.getMetaClass(), methodName, (IRubyObject) args[length - 1]);
                }
            case 5:
                return method.call(context, self, self.getMetaClass(), methodName, (IRubyObject) args[length - 2], (IRubyObject) args[length - 1]);
            case 6:
                return method.call(context, self, self.getMetaClass(), methodName, (IRubyObject) args[length - 3], (IRubyObject) args[length - 2], (IRubyObject) args[length - 1]);
            }
        }
    ...
    public static IRubyObject invokeDynamic(DynamicMethod method, Object selfObj, ThreadContext context, String name) {
        ...
        return method.call(context, self, self.getMetaClass(), name, IRubyObject.NULL_ARRAY);
    }
    ...
    public static IRubyObject invokeDynamic(DynamicMethod method, Object selfObj, ThreadContext context, String name, Block block) {
        IRubyObject self = (IRubyObject) selfObj;
        return method.call(context, self, self.getMetaClass(), name, IRubyObject.NULL_ARRAY, block);
    }
    ...
    public static IRubyObject invokeDynamic(DynamicMethod method, Object selfObj, ThreadContext context, String name, IRubyObject arg, Block block) {
        IRubyObject self = (IRubyObject) selfObj;
        return method.call(context, self, self.getMetaClass(), name, arg, block);
    }
    ...
    public static IRubyObject invokeDynamic(DynamicMethod method, Object selfObj, ThreadContext context, String name, IRubyObject arg0, IRubyObject arg1, Block block) {
        IRubyObject self = (IRubyObject) selfObj;
        return method.call(context, self, self.getMetaClass(), name, arg0, arg1, block);
    }
    ...
    public static IRubyObject invokeDynamic(DynamicMethod method, Object selfObj, ThreadContext context, String name, IRubyObject arg0, IRubyObject arg1, IRubyObject arg2, Block block) {
        IRubyObject self = (IRubyObject) selfObj;
        return method.call(context, self, self.getMetaClass(), name, arg0, arg1, arg2, block);
    }
    ...
    public static IRubyObject invokeDynamic(DynamicMethod method, Object selfObj, ThreadContext context, String name, IRubyObject[] args, Block block) {
        IRubyObject self = (IRubyObject) selfObj;
        return method.call(context, self, self.getMetaClass(), name, args, block);
    }
}

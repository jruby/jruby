...
public class Pre3Rest1Post0Assigner extends Assigner {
    ...
    public Pre3Rest1Post0Assigner(Node parameter1, Node parameter2, Node parameter3, Node rest) {
    ...
    public void assign(Ruby runtime, ThreadContext context, IRubyObject self, IRubyObject values[],
        ...
        switch (length) {
            ...
            default:
                ...
                parameter3.assign(runtime, context, self, values[2], block, false);

                rest.assign(runtime, context, self,
                        runtime.newArrayNoCopyLight(shiftedArray(values, 3)), block, true);
                break;
        }
    }

...
public class Keyword implements Token {
    ...
    private static final Keyword[] wordlist = {
        ...
        new Keyword("rescue", kRESCUE, kRESCUE_MOD, LexState.EXPR_END),
        ...
        new Keyword("break", kBREAK, kBREAK, LexState.EXPR_END),
        ...
        new Keyword("next", kNEXT, kNEXT, LexState.EXPR_END),

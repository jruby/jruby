...
// None is a special value to represent the node cannot be classified as a single node type.
// This is currently only used by when for testing whether when arguments are homogenous.
public enum NodeType {
    ...
    OPTARGNODE, ARGAUXILIARYNODE, LAMBDANODE, MULTIPLEASGN19NODE, RESTARG, NONE;

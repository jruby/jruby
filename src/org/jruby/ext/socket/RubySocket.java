        ...
        try {
            ...
            for(int i = 0; i < addrs.length; i++) {
                ...
                if(sock_dgram) {
                    ...
                    c[4] = r.newFixnum(is_ipv6 ? PF_INET6.intValue() : PF_INET.intValue());
                    c[5] = r.newFixnum(SOCK_DGRAM.intValue());
                    c[6] = r.newFixnum(IPPROTO_UDP.intValue());
                ...
                if(sock_stream) {
                    ...
                    c[3] = r.newString(addrs[i].getHostAddress());
                    c[4] = r.newFixnum(is_ipv6 ? PF_INET6.intValue() : PF_INET.intValue());
                    c[5] = r.newFixnum(SOCK_STREAM.intValue());
                    c[6] = r.newFixnum(IPPROTO_TCP.intValue());
                    l.add(r.newArrayNoCopy(c));
                }
            }
            return r.newArray(l);

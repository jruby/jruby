...
public final class JNAProvider extends FFIProvider {
     ...
     */
    private static interface FunctionInvoker {
     ...
     */
    private static interface Marshaller {
     ...
     */
    private static final class JNAInvoker extends Invoker {
        /**
         * The function to call when execute() is called.
         */
        private final Function function;

        /**
         * The low level invoker used to call the native function.
         */
        private final FunctionInvoker functionInvoker;
        
        /**
         * The marshallers that convert ruby arguments to native arguments.
         */
        private final Marshaller[] marshallers;
        
        /**
         * Creates a new JNAInvoker instance.
         * 
         * @param function The native function to invoke.
         * @param functionInvoker The low level invoker.
         * @param marshallers The parameter converters.
         */
        public JNAInvoker(Function function, FunctionInvoker functionInvoker,
         ...
         * <p>
         * Ruby arguments are converted to native types, and the native return type
         * is converted to the appropriate ruby type.
         * </p>
         * @param runtime The Ruby runtime this method is called on.
         * @param rubyArgs The ruby arguments.
         * @return A ruby object representing the native return value.
         */

...
public class RubyGC {
    public static RubyModule createGCModule(IRuby runtime) {
        ...
        result.getMetaClass().defineFastMethod("start", callbackFactory.getFastSingletonMethod("start"));
        result.getMetaClass().defineFastMethod("garbage_collect", callbackFactory.getFastSingletonMethod("start"));

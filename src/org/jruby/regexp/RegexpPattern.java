...
public abstract class RegexpPattern {
    ...
    protected RegexpPattern(ByteList source, int flags) {
        this.source = source;
        this.flags = flags;
    }

    public abstract RegexpMatcher matcher(String target);
    ...
    public boolean equals(Object other) {
        ...
        if(!ret && other instanceof RegexpPattern) {
            ret = source.equals(((RegexpPattern)other).source) && flags == ((RegexpPattern)other).flags;
        }
        return ret;
    }
}// RegexpPattern

...
public interface IErrno
{
  ...
  int    ECONNABORTED = 74;
  int    EPROTO       = 75;
  //generated additions from osx - m@loonsoft.com
  int    ENOTBLK = 15;
  int    ETXTBSY = 26;
  int    EINPROGRESS = 36;
  int    EALREADY = 37;
  ...
  int    EMSGSIZE = 40;
  int    EPROTOTYPE = 41;
  int    ENOPROTOOPT = 1142;
  int    EPROTONOSUPPORT = 1143;
  int    ESOCKTNOSUPPORT = 1144;
  int    EPFNOSUPPORT = 1146;
  int    EAFNOSUPPORT = 1147;
  int    EADDRNOTAVAIL = 1149;
  int    ENETDOWN = 1150;
  int    ENETUNREACH = 1151;
  int    ENETRESET = 1152;
  int    ENOBUFS = 1155;
  int    EISCONN = 1156;
  int    ENOTCONN = 1157;
  int    ESHUTDOWN = 1158;
  int    ETOOMANYREFS = 1159;
  int    ETIMEDOUT = 1160;
  int    ELOOP = 1162;
  int    EHOSTDOWN = 1164;
  int    EHOSTUNREACH = 1165;
  int    EUSERS = 1168;
  int    EDQUOT = 1169;
  int    ESTALE = 1170;
  int    EREMOTE = 1171;

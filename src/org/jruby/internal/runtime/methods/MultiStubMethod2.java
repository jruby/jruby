 ...
 */
public class MultiStubMethod2 extends AbstractMethod implements
        Cloneable {
    private Arity arity;
    private MultiStub2 stub;
    private int index;
    
    public MultiStubMethod2(MultiStub2 stub, int index, RubyModule implementationClass, Arity arity, Visibility visibility) {
    ...
    public DynamicMethod dup() {
        try {
            MultiStubMethod2 msm = (MultiStubMethod2)clone();
            return msm;

...
public static final int SIZE = FIXNUM | 20;
public static final int HASH = FIXNUM | 21;
public static final int ID2NAME = FIXNUM | 22;
public static final int INVERT = FIXNUM | 23;
public static final int ID = FIXNUM | 24;

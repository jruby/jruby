...
public static final int INSPECT = ARRAY | 1;
public static final int TO_S = ARRAY | 2;
public static final int FROZEN = ARRAY | 3;
public static final int EQUAL = ARRAY | 4;
public static final int EQL = ARRAY | 5;
public static final int HASH = ARRAY | 6;
public static final int AREF = ARRAY | 7;
public static final int ASET = ARRAY | 8;
public static final int FIRST = ARRAY | 9;
public static final int LAST = ARRAY | 10;
public static final int CONCAT = ARRAY | 11;
public static final int APPEND = ARRAY | 12;
public static final int PUSH = ARRAY | 13;
public static final int POP = ARRAY | 14;
public static final int SHIFT = ARRAY | 15;
public static final int UNSHIFT = ARRAY | 16;
public static final int EACH = ARRAY | 17;
public static final int EACH_INDEX = ARRAY | 18;
public static final int REVERSE_EACH = ARRAY | 19;
public static final int LENGTH = ARRAY | 20;
public static final int EMPTY_P = ARRAY | 21;
public static final int INDEX = ARRAY | 22;
public static final int RINDEX = ARRAY | 23;
public static final int INDICES = ARRAY | 24;
public static final int RBCLONE = ARRAY | 25;
public static final int JOIN = ARRAY | 26;
public static final int REVERSE = ARRAY | 27;
public static final int REVERSE_BANG = ARRAY | 28;
public static final int SORT = ARRAY | 29;
public static final int SORT_BANG = ARRAY | 30;
public static final int COLLECT = ARRAY | 31;
public static final int COLLECT_BANG = ARRAY | 32;
public static final int DELETE = ARRAY | 33;
public static final int DELETE_AT = ARRAY | 34;
public static final int DELETE_IF = ARRAY | 35;
public static final int REJECT_BANG = ARRAY | 36;
public static final int REPLACE = ARRAY | 37;
public static final int CLEAR = ARRAY | 38;
public static final int FILL = ARRAY | 39;
public static final int INCLUDE_P = ARRAY | 40;
public static final int OP_CMP = ARRAY | 41;

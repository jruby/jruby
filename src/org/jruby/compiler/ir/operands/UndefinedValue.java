...
public class UndefinedValue extends Operand implements IRubyObject {
    ...
    private RuntimeException undefinedOperation() { 
        return new RuntimeException("IR compiler/interpreter bug: org.jruby.compiler.ir.operands.UndefinedValue should not be used as a valid value during execution.");
    }

...
public class Options {
    ...
    public static final Option<Boolean> COMPILE_FASTSEND = bool(COMPILER, "compile.fastsend", false, "Compile obj.send(:sym, ...) as obj.sym(...).");
    ...
    public static final Option<Integer> INVOKEDYNAMIC_MAXFAIL = integer(INVOKEDYNAMIC, "invokedynamic.maxfail", 2, "Maximum size of invokedynamic PIC.");
    ...
    public static final Option<Boolean> INVOKEDYNAMIC_INVOCATION_JAVA = bool(INVOKEDYNAMIC, "invokedynamic.invocation.java", false, "Bind Ruby to Java invocations with invokedynamic.");

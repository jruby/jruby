...
public class ClassJavaAddons extends JavaObject {
    ...
    public ClassJavaAddons(Ruby runtime, Class<?> javaClass) {
    ...
    public boolean equals(Object other) {
        return other instanceof ClassJavaAddons &&
            this.getValue() == ((ClassJavaAddons)other).getValue();
    }
    ...
    private class InterfaceInitializer implements Initializer {
        ...
        public synchronized void initialize() {
            ...
            ClassJavaAddons.this.staticAssignedNames = Collections.unmodifiableMap(state.staticNames);
            ClassJavaAddons.this.staticInstallers = Collections.unmodifiableMap(state.staticCallbacks);
            ClassJavaAddons.this.constantFields = Collections.unmodifiableList(state.constantFields);
        }
    };
    ...
    private class ClassInitializer implements Initializer {
        ...
        public synchronized void initialize() {
            ...
            ClassJavaAddons.this.staticAssignedNames = Collections.unmodifiableMap(state.staticNames);
            ClassJavaAddons.this.instanceAssignedNames = Collections.unmodifiableMap(state.instanceNames);
            ClassJavaAddons.this.staticInstallers = Collections.unmodifiableMap(state.staticCallbacks);
            ClassJavaAddons.this.instanceInstallers = Collections.unmodifiableMap(state.instanceCallbacks);
            ClassJavaAddons.this.constantFields = Collections.unmodifiableList(state.constantFields);
        }
    }
    ...
    private static class InitializerState {
        ...
        public InitializerState(Ruby runtime, Class superclass) {
            if (superclass == null) {
                ...
                ClassJavaAddons superJavaClass = get(runtime,superclass);
    ...
    public static ClassJavaAddons get(Ruby runtime, Class<?> klass) {
    ...
    public static synchronized ClassJavaAddons forNameVerbose(Ruby runtime, String className) {
        Class <?> klass = null;
        ...
        return ClassJavaAddons.get(runtime, klass);
    }
    
    public static synchronized ClassJavaAddons forNameQuiet(Ruby runtime, String className) {
        Class klass = runtime.getJavaSupport().loadJavaClassQuiet(className);
        return ClassJavaAddons.get(runtime, klass);
    }

    @JRubyMethod(name = "for_name", required = 1, meta = true)
    public static ClassJavaAddons for_name(IRubyObject recv, IRubyObject name) {
    ...
    public IRubyObject annotation(IRubyObject annoClass) {
        if (!(annoClass instanceof ClassJavaAddons)) {
            throw getRuntime().newTypeError(annoClass, getRuntime().getJavaSupport().getJavaClassClass());
        }
        return Java.getInstance(getRuntime(), javaClass().getAnnotation(((ClassJavaAddons)annoClass).javaClass()));
    }
    ...
    public IRubyObject annotation_present_p(IRubyObject annoClass) {
        ...
        return getRuntime().newBoolean(javaClass().isAnnotationPresent(((ClassJavaAddons)annoClass).javaClass()));
    }
    ...
    public IRubyObject declaring_class() {
        ...
        if (clazz != null) {
            return ClassJavaAddons.get(getRuntime(), clazz);
        }
        return getRuntime().getNil();
    }
    ...
    public IRubyObject superclass() {
        ...
        return ClassJavaAddons.get(getRuntime(), superclass);
    }
    ...
    public IRubyObject op_cmp(IRubyObject other) {
        ...
        if (other instanceof ClassJavaAddons) {
            ClassJavaAddons otherClass = (ClassJavaAddons) other;
    ...
    private Class<?>[] buildArgumentTypes(IRubyObject[] args) throws ClassNotFoundException {
        ...
        for (int i = 1; i < args.length; i++) {
            ClassJavaAddons type;
            if (args[i] instanceof ClassJavaAddons) {
                type = (ClassJavaAddons)args[i];
            } else if (args[i].respondsTo("java_class")) {
                type = (ClassJavaAddons)args[i].callMethod(getRuntime().getCurrentContext(), "java_class");
            } else {
    ...
    public RubyArray classes() {
        return ClassJavaAddons.getRubyArray(getRuntime(), javaClass().getClasses());
    }
    ...
    @JRubyMethod
    public ClassJavaAddons array_class() {
        return ClassJavaAddons.get(getRuntime(), Array.newInstance(javaClass(), 0).getClass());
    }
    ...
    public Object javaArrayFromRubyArrayDirect(ThreadContext context, IRubyObject fromArray) {
        ...
        if (javaClass().isArray()) {
            ...
            for (int i = 0; i < rubyArray.size(); i++) {
                ClassJavaAddons componentType = component_type();
    ...
    public RubyArray interfaces() {
        return ClassJavaAddons.getRubyArray(getRuntime(), javaClass().getInterfaces());
    }
    ...
    public RubyBoolean assignable_from_p(IRubyObject other) {
        ...
        Class<?> otherClass = ((ClassJavaAddons) other).javaClass();
    ...
    @JRubyMethod
    public ClassJavaAddons component_type() {
        if (! javaClass().isArray()) {
            throw getRuntime().newTypeError("not a java array-class");
        }
        return ClassJavaAddons.get(getRuntime(), javaClass().getComponentType());
    }

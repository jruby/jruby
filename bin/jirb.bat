...
%_STARTJAVA% -ea -cp %CLASSPATH% -Djruby.base="%JRUBY_BASE%" -Djruby.home="%JRUBY_HOME%" -Djruby.lib="%JRUBY_HOME%\lib" -Djruby.shell="cmd.exe" -Djruby.script=jruby.bat org.jruby.Main %JRUBY_OPTS% %JRUBY_HOME%\bin\jirb --single-irb %*
set E=%ERRORLEVEL%

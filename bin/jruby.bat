...
set CP=%JRUBY_HOME%\lib\jruby.jar;%JRUBY_HOME%\lib\jruby-openssl.jar;%JRUBY_HOME%\lib\jvyaml.jar;%JRUBY_HOME%\lib\plaincharset.jar;%JRUBY_HOME%\lib\asm-2.2.3.jar;%JRUBY_HOME%\lib\asm-commons-2.2.3.jar

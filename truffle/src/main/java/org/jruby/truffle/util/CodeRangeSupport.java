...
public final class CodeRangeSupport {
    ...
    public static boolean isCodeRangeAsciiOnly(CodeRangeable string) {
        return string.getCodeRange() == StringSupport.CR_7BIT;
    }

    public static int codeRangeAnd(int cr1, int cr2) {
        if (cr1 == StringSupport.CR_7BIT) return cr2;
        if (cr1 == StringSupport.CR_VALID) return cr2 == StringSupport.CR_7BIT ? StringSupport.CR_VALID : cr2;

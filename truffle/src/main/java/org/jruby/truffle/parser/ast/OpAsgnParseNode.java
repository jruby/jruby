...
public class OpAsgnParseNode extends ParseNode {
    ...
    public OpAsgnParseNode(SimpleSourcePosition position, ParseNode receiverNode, ParseNode valueNode, String variableName, String operatorName, boolean isLazy) {

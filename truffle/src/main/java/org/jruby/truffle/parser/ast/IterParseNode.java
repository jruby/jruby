...
public class IterParseNode extends ParseNode implements DefNode {
     ...
     */
    public IterParseNode(RubySourceSection position, ParseNode args, StaticScope scope, ParseNode body) {
     ...
     */
    public IterParseNode(RubySourceSection position, ArgsParseNode args, ParseNode body, StaticScope scope) {
        super(position, args != null && args.containsVariableAssignment || body != null && body.containsVariableAssignment);

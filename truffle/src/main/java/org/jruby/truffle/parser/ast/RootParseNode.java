...
public class RootParseNode extends ParseNode {
    ...
    public RootParseNode(RubySourceSection position, DynamicScope scope, ParseNode bodyNode, String file) {
        this(position, scope, bodyNode, file, -1, false);
    }

    public RootParseNode(RubySourceSection position, DynamicScope scope, ParseNode bodyNode, String file, int endPosition, boolean needsCodeCoverage) {
    ...
    @Deprecated
    public RootParseNode(RubySourceSection position, DynamicScope scope, ParseNode bodyNode, String file, int endPosition) {

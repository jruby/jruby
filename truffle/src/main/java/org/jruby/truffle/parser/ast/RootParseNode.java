...
public class RootParseNode extends ParseNode {
    ...
    public RootParseNode(SimpleSourcePosition position, DynamicScope scope, ParseNode bodyNode, String file) {
        this(position, scope, bodyNode, file, -1, false);
    }

    public RootParseNode(SimpleSourcePosition position, DynamicScope scope, ParseNode bodyNode, String file, int endPosition, boolean needsCodeCoverage) {
    ...
    @Deprecated
    public RootParseNode(SimpleSourcePosition position, DynamicScope scope, ParseNode bodyNode, String file, int endPosition) {

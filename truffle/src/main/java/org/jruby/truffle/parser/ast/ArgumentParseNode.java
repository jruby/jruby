...
public class ArgumentParseNode extends ParseNode implements INameNode {
    ...
    public ArgumentParseNode(SimpleSourcePosition position, String identifier) {
        super(position, false);

        this.identifier = identifier;
    }

    public ArgumentParseNode(SimpleSourcePosition position, String identifier, int location) {

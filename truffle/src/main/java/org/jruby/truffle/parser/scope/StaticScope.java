...
public class StaticScope implements Serializable {
     ...
     * @param value
     */
    public AssignableParseNode assign(RubySourceSection position, String name, ParseNode value) {
    ...
    public AssignableParseNode addAssign(RubySourceSection position, String name, ParseNode value) {
    ...
    public ParseNode declare(RubySourceSection position, String name, int depth) {
        int slot = exists(name);
     ...
     */
    public ParseNode declare(RubySourceSection position, String name) {

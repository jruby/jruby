...
public class FCallParseNode extends ParseNode implements INameNode, IArgumentNode, BlockAcceptingParseNode {
    ...
    public FCallParseNode(RubySourceSection position, String name) {
        this(position, name, null, null);
    }
    public FCallParseNode(RubySourceSection position, String name, ParseNode argsNode, ParseNode iterNode) {

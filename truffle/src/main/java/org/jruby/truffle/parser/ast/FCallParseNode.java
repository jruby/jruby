...
public class FCallParseNode extends ParseNode implements INameNode, IArgumentNode, BlockAcceptingParseNode {
    ...
    public FCallParseNode(TempSourceSection position, String name) {
        this(position, name, null, null);
    }
    public FCallParseNode(TempSourceSection position, String name, ParseNode argsNode, ParseNode iterNode) {

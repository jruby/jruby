...
public class ReadLiteralConstantNode extends RubyNode {
    ...
    public ReadLiteralConstantNode(RubyContext context, SourceSection sourceSection, LexicalScope lexicalScope, RubyNode module, String name) {
        super(context, sourceSection);
        RubyNode nameNode = new LiteralNode(context, sourceSection, name);
        this.readConstantNode = ReadConstantNodeGen.create(context, sourceSection, lexicalScope, module, nameNode);
    }

...
public abstract class RegexpNodes {
    ...
    public abstract static class EscapeNode extends CoreMethodArrayArgumentsNode {
        ...
        public RubyString escape(RubyString pattern) {
            return StringNodes.createString(getContext().getCoreLibrary().getStringClass(), org.jruby.RubyRegexp.quote19(new ByteList(pattern.getByteList()), true).toString());
        }
    ...
    public abstract static class InspectNode extends CoreMethodArrayArgumentsNode {
        ...
        public RubyString match(RubyRegexp regexp) {
            return StringNodes.createString(getContext().getCoreLibrary().getStringClass(), ((org.jruby.RubyString) org.jruby.RubyRegexp.newRegexp(getContext().getRuntime(), regexp.getSource(), regexp.getRegex().getOptions()).inspect19()).getByteList());
        }
    ...
    public abstract static class QuoteNode extends CoreMethodArrayArgumentsNode {
        ...
        public RubyString quote(RubyString raw) {
            ...
            return StringNodes.createString(getContext().getCoreLibrary().getStringClass(), org.jruby.RubyRegexp.quote19(raw.getByteList(), isAsciiOnly));
        }
    ...
    public abstract static class SourceNode extends CoreMethodArrayArgumentsNode {
        ...
        public RubyString source(RubyRegexp regexp) {
            return StringNodes.createString(getContext().getCoreLibrary().getStringClass(), regexp.getSource().dup());
        }
    ...
    public abstract static class ToSNode extends CoreMethodArrayArgumentsNode {
        ...
        public RubyString to_s(RubyRegexp regexp) {
            return StringNodes.createString(getContext().getCoreLibrary().getStringClass(), ((org.jruby.RubyString) org.jruby.RubyRegexp.newRegexp(getContext().getRuntime(), regexp.getSource(), regexp.getRegex().getOptions()).to_s()).getByteList());
        }

...
public abstract class MethodNodes {
    ...
    public abstract static class EqualNode extends CoreMethodArrayArgumentsNode {
        ...
        public boolean equal(VirtualFrame frame, DynamicObject a, DynamicObject b) {
            return areSame(frame, METHOD_LAYOUT.getReceiver(a), METHOD_LAYOUT.getReceiver(b)) && METHOD_LAYOUT.getMethod(a) == METHOD_LAYOUT.getMethod(b);
        }
    ...
    public abstract static class ArityNode extends CoreMethodArrayArgumentsNode {
        ...
        public int arity(DynamicObject method) {
            return METHOD_LAYOUT.getMethod(method).getSharedMethodInfo().getArity().getArityNumber();
        }
    ...
    public abstract static class CallNode extends CoreMethodArrayArgumentsNode {
        ...
        protected Object call(VirtualFrame frame, DynamicObject method, Object[] arguments, Object block) {
            final InternalMethod internalMethod = METHOD_LAYOUT.getMethod(method);
        ...
        private Object[] packArguments(DynamicObject method, InternalMethod internalMethod, Object[] arguments, Object block) {
            return RubyArguments.pack(
                    ...
                    METHOD_LAYOUT.getReceiver(method),
    ...
    public abstract static class NameNode extends CoreMethodArrayArgumentsNode {
        ...
        public DynamicObject name(DynamicObject method) {
            ...
            return getSymbol(METHOD_LAYOUT.getMethod(method).getName());
        }
    ...
    public abstract static class OwnerNode extends CoreMethodArrayArgumentsNode {
        ...
        public DynamicObject owner(DynamicObject method) {
            return METHOD_LAYOUT.getMethod(method).getDeclaringModule();
        }
    ...
    public abstract static class ParametersNode extends CoreMethodArrayArgumentsNode {
        ...
        public DynamicObject parameters(DynamicObject method) {
            final ArgsNode argsNode = METHOD_LAYOUT.getMethod(method).getSharedMethodInfo().getParseTree().findFirstChild(ArgsNode.class);
    ...
    public abstract static class SourceLocationNode extends CoreMethodArrayArgumentsNode {
        ...
        public Object sourceLocation(DynamicObject method) {
            ...
            SourceSection sourceSection = METHOD_LAYOUT.getMethod(method).getSharedMethodInfo().getSourceSection();
    ...
    public abstract static class UnbindNode extends CoreMethodArrayArgumentsNode {
        ...
        public DynamicObject unbind(VirtualFrame frame, DynamicObject method) {
            final DynamicObject receiverClass = classNode.executeGetClass(frame, METHOD_LAYOUT.getReceiver(method));
            return UnboundMethodNodes.createUnboundMethod(getContext().getCoreLibrary().getUnboundMethodClass(), receiverClass, METHOD_LAYOUT.getMethod(method));
        }
    ...
    public abstract static class ToProcNode extends CoreMethodArrayArgumentsNode {
        ...
        public DynamicObject toProcUncached(DynamicObject methodObject) {
            ...
            final InternalMethod method = METHOD_LAYOUT.getMethod(methodObject);
            ...
            return ProcNodes.createRubyProc(
                    ...
                    method,
                    METHOD_LAYOUT.getReceiver(methodObject),
                    null);
        }
        ...
        protected CallTarget method2proc(DynamicObject methodObject) {
            ...
            final SetReceiverNode setReceiverNode = new SetReceiverNode(getContext(), sourceSection, METHOD_LAYOUT.getReceiver(methodObject), method.getCallTarget());

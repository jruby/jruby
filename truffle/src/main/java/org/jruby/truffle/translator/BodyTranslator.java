...
public class BodyTranslator extends Translator {
    ...
    public RubyNode visitCallNode(CallNode node) {
        ...
        if (receiver instanceof org.jruby.ast.ConstNode
            ...
            if (methodName.equals("omit")) {
                ...
                && sourceSection.getSource().getPath().startsWith("truffle:/core/")
    ...
    public RubyNode visitConstNode(org.jruby.ast.ConstNode node) {
        ...
        if (name.equals("Rubinius") && sourceSection.getSource().getPath().startsWith("truffle:/core/rubinius")) {
    ...
    public RubyNode visitGlobalVarNode(org.jruby.ast.GlobalVarNode node) {
        ...
        if (FRAME_LOCAL_GLOBAL_VARIABLES.contains(name)) {
            ...
            if (name.equals("$_")) {
                if (sourceSection.getSource().getPath().equals("truffle:/core/rubinius/common/regexp.rb")) {
    ...
    public RubyNode visitInstAsgnNode(org.jruby.ast.InstAsgnNode node) {
        ...
        if (sourceSection.getSource().getPath().equals("truffle:/core/rubinius/common/time.rb")) {
        ...
        if (sourceSection.getSource().getPath().equals("truffle:/core/rubinius/common/hash.rb")) {
        ...
        if (sourceSection.getSource().getPath().equals("truffle:/core/rubinius/bootstrap/string.rb") ||
                sourceSection.getSource().getPath().equals("truffle:/core/rubinius/common/string.rb")) {
        ...
        if (sourceSection.getSource().getPath().equals("truffle:/core/rubinius/common/range.rb")) {
        ...
        if (sourceSection.getSource().getPath().equals("truffle:/core/rubinius/common/io.rb")) {
    ...
    public RubyNode visitInstVarNode(org.jruby.ast.InstVarNode node) {
        ...
        if (sourceSection.getSource().getPath().equals("truffle:/core/rubinius/common/array.rb") ||
                sourceSection.getSource().getPath().equals("truffle:/core/rubinius/api/shims/array.rb")) {
        ...
        if (sourceSection.getSource().getPath().equals("truffle:/core/rubinius/common/range.rb") ||
                sourceSection.getSource().getPath().equals("truffle:/core/rubinius/api/shims/range.rb")) {
    ...
    public RubyNode visitVCallNode(org.jruby.ast.VCallNode node) {
        final SourceSection sourceSection = translate(node.getPosition());
        if (node.getName().equals("undefined") && sourceSection.getSource().getPath().startsWith("truffle:/core/")) {

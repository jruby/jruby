...
class TestString < Rubicon::TestCase
  ...
  def test_center
    ...
    Version.less_than("1.8.2") do 
      assert_equal(S("    hi     "), S("hi").center(11, ""))
    end
  end
  ...
  def generic_test_intern(method)
    ...
    if Version > "1.6.8"
      ...
      # empty Symbols were allowed in 1.6.8
      sym = S("").send(method)
      assert_instance_of(Symbol, sym)
      assert_equal("", sym.to_s)
    end
  ...
  def test_ljust
    ...
    Version.less_than("1.8.2") do 
      assert_equal(S("hi         "), S("hi").ljust(11, ""))
    end
  end
  ...
  def test_rjust
    ...
    Version.less_than("1.8.2") do 
      assert_equal(S("         hi"), S("hi").rjust(11, ""))
    end
  end

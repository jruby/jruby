...
class TestAccessControl < Rubicon::TestCase
  ...
  def test_class_access
    ...
    # access via subclass
    c2 = C2.new
    assert_raise(ExpectedException) { c2.c1private }
    assert_raise(ExpectedException) { c2.c1protected }
    ...
    c3 = C3.new
    assert_raise(ExpectedException) { c3.c3private }
  ...
  def test_included_module
    c4 = C4.new
    assert_raise(ExpectedException) { c4.m1private }
    assert_raise(ExpectedException) { c4.m1protected }
  ...
  def test_module_functions
    ...
    c5 = C5.new
    assert_raise(ExpectedException) { c5.m2private }
    assert_raise(ExpectedException) { c5.m2protected }

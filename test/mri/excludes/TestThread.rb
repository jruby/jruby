...
exclude :test_stack_size, 'often too expensive'
...
exclude :test_yield_across_thread_through_enum, "JRuby prevents parallelism in enum in a different way than CRuby"

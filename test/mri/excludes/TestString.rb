...
exclude :test_eq_tilde_can_be_overridden, "selectors are not yet supported (https://github.com/jruby/jruby/issues/9267)"
exclude :test_fs, "aliased globals do not know their new name (https://github.com/jruby/jruby/issues/9177)"
...
exclude :test_lstrip_bang_with_chars, "selectors are not yet supported (https://github.com/jruby/jruby/issues/9267)"
exclude :test_lstrip_with_selectors, "selectors are not yet supported (https://github.com/jruby/jruby/issues/9267)"
exclude :test_rindex, "needs investigation"
exclude :test_rs, "aliased globals do not know their new name (https://github.com/jruby/jruby/issues/9177)"
exclude :test_rstrip_bang, "needs investigation"
exclude :test_rstrip_bang_with_chars, "selectors are not yet supported (https://github.com/jruby/jruby/issues/9267)"
exclude :test_rstrip_with_selectors, "selectors are not yet supported (https://github.com/jruby/jruby/issues/9267)"
exclude :test_scan_gc_compact_stress, "GC is not configurable"
exclude :test_scan_segv, "requires ObjectSpace.each_object"
exclude :test_split_with_block, "test for use-after-free in CRuby not possible in JRuby"
...
exclude :test_strip_bang_with_chars, "selectors are not yet supported (https://github.com/jruby/jruby/issues/9267)"
exclude :test_strip_with_selectors, "selectors are not yet supported (https://github.com/jruby/jruby/issues/9267)"

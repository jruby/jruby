...
exclude :test_refinements, "may be intermittent, failed in JIT mode on Java 23 on Linux CI on GHA"
exclude :test_super_to_module, "issues finding proper super hierarchy, perhaps related to #5585"
exclude :test_target, "may be intermittent, failed in JIT mode on Java 23 on Linux CI on GHA"

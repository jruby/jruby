...
exclude :test_dump_flag_age, "depends on running without GC"
exclude :test_dump_flags, "dumping is largely a CRuby-specific feature"
exclude :test_dump_include_shareable, "dumping is largely a CRuby-specific feature"
...
exclude :test_dump_outputs_object_id, "dumping is largely a CRuby-specific feature"
...
exclude :test_trace_object_allocations_with_other_tracepoint, "no support on JVM for live allocation tracking"
